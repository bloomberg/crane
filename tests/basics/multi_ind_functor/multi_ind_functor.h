  ...
  public:
    ...
    __attribute__((pure)) maybe clone() const {
      ...
      if (std::holds_alternative<Nothing>(_sv.v())) {
        ...
        return maybe(Just{clone_as_value<unsigned int>(d_a0)});
      }
    }
  ...
  public:
    ...
    __attribute__((pure)) mlist clone() const {
      ...
      if (std::holds_alternative<MNil>(_sv.v())) {
        ...
        return mlist(MCons{clone_as_value<maybe>(d_a0),
                           clone_as_value<std::unique_ptr<mlist>>(d_a1)});
      }
    }
    ...
    __attribute__((pure)) static mlist mcons(maybe a0, const mlist &a1) {
      return mlist(MCons{std::move(a0), std::make_unique<mlist>(a1.clone())});
    }
  ...
  public:
    ...
    __attribute__((pure)) mtree clone() const {
      ...
      if (std::holds_alternative<Leaf>(_sv.v())) {
        ...
        return mtree(Leaf{clone_as_value<maybe>(d_a0)});
      } else {
        const auto &[d_a0] = std::get<Node>(_sv.v());
        return mtree(Node{clone_as_value<mlist>(d_a0)});
      }
    }
