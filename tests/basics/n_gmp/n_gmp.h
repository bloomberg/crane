...
struct NGMPTest {
  ...
  static mpz_class div_test(const mpz_class, const mpz_class);
  ...
  static mpz_class succ_test(const mpz_class);

  static mpz_class pred_test(const mpz_class);

  static mpz_class double_test(const mpz_class);
  ...
  static mpz_class pos_add(const mpz_class, const mpz_class);

  static mpz_class pos_succ(const mpz_class);
};
