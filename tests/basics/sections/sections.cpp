...
unsigned int Sections::sum_ab(const unsigned int &_x0,
                              const unsigned int &_x1) {
  return (_x0 + _x1);
}

unsigned int Sections::prod_ab(const unsigned int &_x0,
                               const unsigned int &_x1) {
  return (_x0 * _x1);
}

unsigned int Sections::use_inner(const unsigned int &a) {
  return sum_ab(a, 3u);
}
