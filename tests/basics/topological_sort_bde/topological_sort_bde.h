...
const auto& [d_a0, d_a1] = bsl::get<Cons>(_sv.v());
return List<_CloneT0>(typename List<_CloneT0>::Cons{clone_as_value<_CloneT0>(d_a0),
clone_as_value<std::unique_ptr<List<_CloneT0>>>(d_a1)});
}}
  // CREATORS
__attribute__((pure)) static List<t_A> nil(){
return List(Nil{});}
__attribute__((pure)) static List<t_A> cons(t_A a0,
const List<t_A>& a1){
return List(Cons{bsl::move(a0),
bsl::make_unique<List<t_A>>(a1.clone())});}
  // MANIPULATORS
__attribute__((pure)) variant_t& v_mut() {
return d_v_;}
  // ACCESSORS
__attribute__((pure)) List<t_A>* operator->() {
return this;}
__attribute__((pure)) const List<t_A>* operator->() const {
return this;}
...
template <typename
T1>
__attribute__((pure)) List<bsl::pair<t_A, T1>> combine(const List<T1>& l_) const {
auto&& _sv = *(this);
...
return List<bsl::pair<t_A, T1>>::cons(bsl::make_pair(d_a0, d_a00),
(*(d_a1)).template combine<T1>(*(d_a10)));
}
}}
template <MapsTo<bool, t_A>
F0>
...
const auto& [d_a0, d_a1] = bsl::get<typename List<t_A>::Cons>(_sv.v());
if (f(d_a0)) { return List<t_A>::cons(d_a0,
(*(d_a1)).filter(f)); } else { return (*(d_a1)).filter(f); }
}}
...
template <typename
T1>
__attribute__((pure)) List<T1> concat() const {
auto&& _sv = *(this);
if (bsl::holds_alternative<typename List<List<T1>>::Nil>(_sv.v())) {
return List<T1>::nil();
} else {
const auto& [d_a0, d_a1] = bsl::get<typename List<List<T1>>::Cons>(_sv.v());
return clone_as_value<List<T1>>(d_a0).app((*(d_a1)).template concat<T1>());
}}
template <typename T1, MapsTo<T1, t_A>
F0>
...
const auto& [d_a0, d_a1] = bsl::get<typename List<t_A>::Cons>(_sv.v());
return List<T1>::cons(f(d_a0),
(*(d_a1)).template map<T1>(f));
}}
...
MapsTo<bsl::string, T2>
F1>
__attribute__((pure)) static bsl::string pair_to_string(F0&& p1, F1&& p2,
const bsl::pair<T1, T2>& x){T1 a = x.first; T2 b = x.second; return "("_s + p1(a) + ", "_s + p2(b) + ")"_s;}
template <typename T1, MapsTo<bsl::string, T1> F0>
__attribute__((pure)) static bsl::string intersperse(F0&& p,
const bsl::string sep,
...
}}template <typename T1, MapsTo<bsl::string, T1>
F0>
...
T1, MapsTo<bool, T1, T1>
F0>
__attribute__((pure)) static List<T1> get_elems(F0&& eqb_node,
const List<bsl::pair<T1, T1>>& l){bsl::function<List<T1>(List<bsl::pair<T1, T1>>,
List<T1>)> get_elems_aux;
get_elems_aux = [&](List<bsl::pair<T1, T1>> l0, List<T1>
h) -> List<T1> {
...
List<bsl::pair<T1, T1>> d_a1_value = clone_as_value<List<std::pair<T1, T1>>>(d_a1);
T1 e1 = d_a0.first; T1 e2 = d_a0.second; bsl::optional<T1> f1 = h.find([=](const T1
x) mutable {
...
if (f1.has_value()) { T1 _x = *f1; if (f2.has_value()) { T1 _x0 = *f2; return get_elems_aux(d_a1_value,
h); } else { return get_elems_aux(d_a1_value, List<T1>::cons(e2,
h)); } } else { if (f2.has_value()) { T1 _x = *f2; return get_elems_aux(d_a1_value,
List<T1>::cons(e1, h)); } else { if (eqb_node(e1,
e2)) { return get_elems_aux(d_a1_value, List<T1>::cons(e1,
h)); } else { return get_elems_aux(d_a1_value, List<T1>::cons(e1,
List<T1>::cons(e2, h))); } } }
}
};
return get_elems_aux(l, List<T1>::nil());}template <typename T1,
MapsTo<bool, T1, T1>
F0>
__attribute__((pure)) static entry<T1> make_entry(F0&& eqb_node,
const List<bsl::pair<T1, T1>>& l,
const T1 e){return bsl::make_pair(e, l.template fold_right<List<T1>>([=](const bsl::pair<T1, T1>&
x, List<T1> ret) mutable {
if (eqb_node(e, x.first)) { return List<T1>::cons(x.second,
ret); } else { return ret; }
}, List<T1>::nil()));}template <typename T1, MapsTo<bool, T1, T1>
F0>
__attribute__((pure)) static graph<T1> make_graph(F0&& eqb_node,
List<bsl::pair<T1, T1>> l){List<T1> elems = get_elems<T1>(eqb_node,
l);
return elems.template fold_right<List<entry<T1>>>([=](const T1 e,
List<bsl::pair<T1, List<T1>>>
ret) mutable {
return List<bsl::pair<T1, List<T1>>>::cons(make_entry<T1>(eqb_node, l, e),
ret);
}, List<bsl::pair<T1, List<T1>>>::nil());}template <typename T1,
MapsTo<bool, T1, T1>
F0>
__attribute__((pure)) static List<T1> graph_lookup(F0&& eqb_node,
const T1 elem,
...
if (_cs.has_value()) { bsl::pair<T1, List<T1>> p = *_cs; T1 _x = p.first; List<T1> es = p.second; return es; } else { return List<T1>::nil(); }}
...
template <typename T1, MapsTo<bool, T1, T1>
F0>
static T1 cycle_entry_aux(F0&& eqb_node,
const List<bsl::pair<T1, List<T1>>>& graph0, List<T1> seens, const T1 elem,
const unsigned int& counter){if (contains<T1>(eqb_node, elem,
...
const auto& [d_a0, d_a1] = bsl::get<typename List<T1>::Cons>(l.v());
return cycle_entry_aux<T1>(eqb_node, graph0, List<T1>::cons(elem, seens),
d_a0, c);
} } }}template <typename T1, MapsTo<bool, T1, T1>
F0>
__attribute__((pure)) static bsl::optional<T1> cycle_entry(F0&& eqb_node,
...
T1 e = clone_as_value<std::pair<T1, List<T1>>>(d_a0).first; List<T1> _x0 = clone_as_value<std::pair<T1, List<T1>>>(d_a0).second; return bsl::make_optional<T1>(cycle_entry_aux<T1>(eqb_node,
graph0, List<T1>::nil(), e, graph0.length()));
}}template <typename T1, MapsTo<bool, T1, T1>
F0>
__attribute__((pure)) static List<T1> cycle_extract_aux(F0&& eqb_node,
List<bsl::pair<T1, List<T1>>> graph0, const unsigned int& counter,
const T1 elem,
...
}, List<T1>::cons(elem, cycl)); } }}template <typename T1, MapsTo<bool, T1,
T1> F0>
__attribute__((pure)) static List<T1> cycle_extract(F0&& eqb_node,
...
T1>
__attribute__((pure)) static bool null(const List<T1>& xs){if (bsl::holds_alternative<typename List<T1>::Nil>(xs.v())) {
return true;
} else {
return false;
}}template <typename T1, MapsTo<bool, T1, T1>
F0>
__attribute__((pure)) static order<T1> topological_sort_aux(F0&& eqb_node,
const List<bsl::pair<T1, List<T1>>>& graph0,
const unsigned int& counter){if (counter <= 0) { return List<List<T1>>::nil(); } else { unsigned int c = counter - 1; if (null<entry<T1>>(graph0)) { return List<List<T1>>::nil(); } else { List<T1> mins = graph0.filter([](const bsl::pair<T1, List<T1>>&
p) {
...
List<bsl::pair<T1, List<T1>>> rest_ = rest.template map<bsl::pair<T1, List<T1>>>([=](const bsl::pair<T1, List<T1>>&
entry0) mutable {
...
return List<List<T1>>::cons(mins_, topological_sort_aux<T1>(eqb_node, rest_,
c)); } }}template <typename T1, MapsTo<bool, T1, T1>
F0>
__attribute__((pure)) static List<List<T1>> topological_sort(F0&& eqb_node,
...
template <typename T1, MapsTo<bool, T1, T1>
F0>
__attribute__((pure)) static order<T1> topological_sort_graph(F0&& eqb_node,
const List<bsl::pair<T1, List<T1>>>& graph0){return topological_sort_aux<T1>(eqb_node,
graph0, graph0.length());}template <typename T1, MapsTo<bool, T1, T1>
F0>
__attribute__((pure)) static List<bsl::pair<T1, unsigned int>> topological_rank_list(F0&& eqb_node,
...
lorder.length())).template map<List<bsl::pair<T1, unsigned int>>>([](const bsl::pair<List<T1>, unsigned int>&
x) {
List<T1> fs = x.first; unsigned int rk = x.second; return fs.template map<bsl::pair<T1, unsigned int>>([=](const T1
f) mutable {
