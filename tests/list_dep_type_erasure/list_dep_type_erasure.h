#ifndef INCLUDED_LIST_DEP_TYPE_ERASURE
#define INCLUDED_LIST_DEP_TYPE_ERASURE
...
struct ListDepTypeErasure {
  struct dyn {
    List<std::any> contents;
  };
...
#endif // INCLUDED_LIST_DEP_TYPE_ERASURE
