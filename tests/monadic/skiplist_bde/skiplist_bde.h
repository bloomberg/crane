...
return SkipList<int, int>::template findPath_aux<K, V>(ltK,
bsl::move(*(this)).SkipList::slHead, target, lvl,
path);}
template <MapsTo<bool, K, K> F0, MapsTo<bool, K, K>
F1>
...
(*(this)).SkipList::slHead, (newLevel + 1),
curLvl);
bsl::shared_ptr<SkipNode<K, V>> pred0 = path.get(0u);
bsl::optional<bsl::shared_ptr<SkipNode<K, V>>> nextOpt = ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<K, V>>>(pred0->forward[0u]));
...
newN);
if (curLvl < newLevel) { stm::writeTVar(bsl::move(*(this)).SkipList::slLevel, newLevel);
...
bsl::optional<bsl::shared_ptr<SkipNode<K, V>>> nextOpt = ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<K, V>>>(pred0->forward[0u]));
if (nextOpt.has_value()) { bsl::shared_ptr<SkipNode<K, V>> node = *nextOpt; if (eqK(node->key,
k)) { unsigned int curLvl = stm::readTVar((*(this)).SkipList::slLevel);
SkipList<int, int>::template extendPath<K, V>(path,
(*(this)).SkipList::slHead, (node->level + 1),
curLvl);
...
bsl::optional<bsl::shared_ptr<SkipNode<K, V>>> firstOpt = ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<K, V>>>((*(this)).SkipList::slHead->forward[0u]));
...
bsl::optional<bsl::shared_ptr<SkipNode<K, V>>> firstOpt = ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<K, V>>>((*(this)).SkipList::slHead->forward[0u]));
return SkipList<int, int>::template length_aux<K, V>(10000u, firstOpt,
0u);}
template <MapsTo<bool, K, K> F0, MapsTo<bool, K, K> F1>
...
return ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<K, V>>>((*(this)).SkipList::slHead->forward[0u]));}
...
V>(bsl::move(*(this)).SkipList::slHead, node,
node->level);
...
V>(eqK, 10000u, first, bsl::move(*(this)).SkipList::slHead,
...
bsl::optional<bsl::shared_ptr<SkipNode<K, V>>> nextOpt = ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<K, V>>>(pred0->forward[0u]));
if (nextOpt.has_value()) { bsl::shared_ptr<SkipNode<K, V>> node = *nextOpt; if (eqK(node->key,
k)) { SkipList<int, int>::template extendPath<K, V>(path,
bsl::move(*(this)).SkipList::slHead, (node->level + 1),
curLvl);
SkipList<int, int>::template unlinkNode<K, V>(path,
node);
...
unsigned int curLvl = stm::readTVar((*(this)).SkipList::slLevel);
SkipList<int, int>::template extendPath<K, V>(path,
(*(this)).SkipList::slHead, (level + 1),
curLvl);
bsl::optional<bsl::shared_ptr<SkipNode<K, V>>> curFront = ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<K, V>>>((*(this)).SkipList::slHead->forward[0u]));
bool isNewFront;
...
newN);
[&]() -> void {
if (curLvl < level) { stm::writeTVar(bsl::move(*(this)).SkipList::slLevel, level);
return; } else { return; }
}();
...
bsl::optional<bsl::shared_ptr<SkipNode<K, V>>> frontOpt = ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<K, V>>>((*(this)).SkipList::slHead->forward[0u]));
...
unsigned int lvl = stm::readTVar((*(this)).SkipList::slLevel);
return SkipList<int, int>::template findKey_aux<K, V>(ltK, eqK,
bsl::move(*(this)).SkipList::slHead, key0,
lvl);}
...
key0);
if (result.has_value()) { bsl::shared_ptr<SkipNode<K, V>> node = *result; return bsl::make_pair(SkipList<int, int>::e_SUCCESS, bsl::make_optional<bsl::shared_ptr<SkipNode<K, V>>>(node)); } else { return bsl::make_pair(SkipList<int, int>::e_NOT_FOUND, bsl::optional<bsl::shared_ptr<SkipNode<K, V>>>()); }}
template <typename T1, typename T2, MapsTo<bool, T1, T1>
F0>
static bsl::shared_ptr<SkipNode<T1, T2>> findPred_go(F0&& ltK,
const unsigned int& fuel, const bsl::shared_ptr<SkipNode<T1, T2>> curr,
const T1 target,
unsigned int level){bsl::shared_ptr<SkipNode<T1, T2>> _result;
bsl::shared_ptr<SkipNode<T1, T2>> _loop_curr = curr;
unsigned int _loop_fuel = fuel;
while (true) {
if (_loop_fuel <= 0) { _result = _loop_curr;
break; } else { unsigned int fuel_ = _loop_fuel - 1; bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>> nextOpt = ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<T1, T2>>>(_loop_curr->forward[level]));
if (nextOpt.has_value()) { bsl::shared_ptr<SkipNode<T1, T2>> next0 = *nextOpt; if (ltK(next0->key,
target)) { bsl::shared_ptr<SkipNode<T1, T2>> _next_curr = next0;
unsigned int _next_fuel = fuel_;
_loop_curr = bsl::move(_next_curr);
_loop_fuel = bsl::move(_next_fuel); } else { _result = _loop_curr;
break; } } else { _result = _loop_curr;
break; } }
}
return _result;}template <typename T1, typename T2, MapsTo<bool, T1, T1>
F0>
static bsl::shared_ptr<SkipNode<T1, T2>> findPred(F0&& ltK,
const bsl::shared_ptr<SkipNode<T1, T2>> curr, const T1 target,
const unsigned int& level){return SkipList<int, int>::template findPred_go<T1,
...
const bsl::shared_ptr<SkipNode<T1, T2>> curr, const T1 target,
unsigned int level,
const SkipPath<T1, T2> path){SkipPath<T1, T2> _result;
...
if (_loop_level <= 0) { _result = path;
break; } else { unsigned int level_ = _loop_level - 1; unsigned int _next_level = level_;
bsl::shared_ptr<SkipNode<T1, T2>> _next_curr = pred;
_loop_level = bsl::move(_next_level);
_loop_curr = bsl::move(_next_curr); }
}
return _result;}template <typename T1, typename
T2>
...
stm::writeTVar<bsl::shared_ptr<SkipNode<T1, T2>>>(newNode->forward[level], opt_to_ptr(oldNext));
...
const bsl::shared_ptr<SkipNode<T1, T2>> head, const unsigned int& level,
unsigned int maxLevel){unsigned int _loop_level = level;
while (true) {
...
const bsl::shared_ptr<SkipNode<T1, T2>> head, const unsigned int& needed,
...
const bsl::shared_ptr<SkipNode<T1, T2>> newNode){unsigned int lvl = newNode->level;
...
stm::writeTVar<bsl::shared_ptr<SkipNode<T1, T2>>>(pred->forward[level], opt_to_ptr(targetNext));
return;}template <typename T1, typename
T2>
...
const bsl::shared_ptr<SkipNode<T1, T2>> target){unsigned int lvl = target->level;
SkipList<int, int>::template unlinkNode_aux<T1, T2>(path, target,
lvl);
return;}template <typename T1, typename T2, MapsTo<bool, T1, T1> F0,
MapsTo<bool, T1, T1> F1>
static bool findKey_aux(F0&& ltK, F1&& eqK,
const bsl::shared_ptr<SkipNode<T1, T2>> curr, const T1 target,
unsigned int level){bool _result;
unsigned int _loop_level = bsl::move(level);
bsl::shared_ptr<SkipNode<T1, T2>> _loop_curr = curr;
while (true) {
bsl::shared_ptr<SkipNode<T1, T2>> pred = SkipList<int, int>::template findPred<T1,
T2>(ltK, _loop_curr, target,
_loop_level);
if (_loop_level <= 0) { bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>> nextOpt = ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<T1, T2>>>(pred->forward[0u]));
if (nextOpt.has_value()) { bsl::shared_ptr<SkipNode<T1, T2>> node = *nextOpt; _result = eqK(node->key,
target);
...
return _result;}template <typename T1, typename
T2>
static unsigned int length_aux(const unsigned int& fuel,
const bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>>& node,
unsigned int acc){unsigned int _result;
unsigned int _loop_acc = bsl::move(acc);
bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>> _loop_node = node;
unsigned int _loop_fuel = fuel;
while (true) {
if (_loop_fuel <= 0) { _result = _loop_acc;
break; } else { unsigned int fuel_ = _loop_fuel - 1; if (_loop_node.has_value()) { bsl::shared_ptr<SkipNode<T1, T2>> n = *_loop_node; bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>> nextOpt = ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<T1, T2>>>(n->forward[0u]));
...
_loop_fuel = bsl::move(_next_fuel); } else { _result = _loop_acc;
break; } }
}
return _result;}template <typename T1, typename
T2>
static bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>> findLast_aux(const unsigned int& fuel,
const bsl::shared_ptr<SkipNode<T1, T2>> curr){bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>> _result;
bsl::shared_ptr<SkipNode<T1, T2>> _loop_curr = curr;
unsigned int _loop_fuel = fuel;
while (true) {
if (_loop_fuel <= 0) { _result = bsl::make_optional<bsl::shared_ptr<SkipNode<T1, T2>>>(_loop_curr);
break; } else { unsigned int fuel_ = _loop_fuel - 1; bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>> nextOpt = ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<T1, T2>>>(_loop_curr->forward[0u]));
if (nextOpt.has_value()) { bsl::shared_ptr<SkipNode<T1, T2>> next0 = *nextOpt; bsl::shared_ptr<SkipNode<T1, T2>> _next_curr = next0;
unsigned int _next_fuel = fuel_;
_loop_curr = bsl::move(_next_curr);
_loop_fuel = bsl::move(_next_fuel); } else { _result = bsl::make_optional<bsl::shared_ptr<SkipNode<T1, T2>>>(_loop_curr);
break; } }
}
return _result;}template <typename T1, typename
T2>
...
return;}template <typename T1, typename
T2>
static void unlinkNodeAtAllLevels(const bsl::shared_ptr<SkipNode<T1, T2>> head,
const bsl::shared_ptr<SkipNode<T1, T2>> node,
unsigned int lvl){unsigned int _loop_lvl = bsl::move(lvl);
while (true) {
bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>> nodeNext = ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<T1, T2>>>(node->forward[_loop_lvl]));
...
return;}template <typename T1, typename
T2>
static unsigned int removeAll_aux(const unsigned int& fuel,
const bsl::shared_ptr<SkipNode<T1, T2>> head,
...
T2>
static bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>> next(const bsl::shared_ptr<SkipNode<T1, T2>> pair){return ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<T1, T2>>>(pair->forward[0u]));}
...
const T1 target){bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>> _result;
bsl::shared_ptr<SkipNode<T1, T2>> _loop_x = _x;
bsl::shared_ptr<SkipNode<T1, T2>> _loop_curr = curr;
unsigned int _loop_fuel = fuel;
while (true) {
if (_loop_fuel <= 0) { _result = bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>>();
break; } else { unsigned int fuel_ = _loop_fuel - 1; bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>> nextOpt = ptr_to_opt(stm::readTVar<bsl::shared_ptr<SkipNode<T1, T2>>>(_loop_curr->forward[0u]));
if (nextOpt.has_value()) { bsl::shared_ptr<SkipNode<T1, T2>> next0 = *nextOpt; if (eqK(next0->key,
target)) { _result = bsl::make_optional<bsl::shared_ptr<SkipNode<T1, T2>>>(_loop_curr);
break; } else { bsl::shared_ptr<SkipNode<T1, T2>> _next_x = _loop_curr;
bsl::shared_ptr<SkipNode<T1, T2>> _next_curr = next0;
unsigned int _next_fuel = fuel_;
_loop_x = bsl::move(_next_x);
_loop_curr = bsl::move(_next_curr);
_loop_fuel = bsl::move(_next_fuel); } } else { _result = bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>>();
break; } }
}
return _result;}template <typename T1, typename
T2>
static T1 key(const bsl::shared_ptr<SkipNode<T1, T2>> _x0){return _x0->key;}
template <typename T1, typename
T2>
static T2 data(const bsl::shared_ptr<SkipNode<T1, T2>> _x0){return stm::readTVar<T2>(_x0->value);}
static inline const unsigned int e_SUCCESS = 0u;static inline const unsigned int e_NOT_FOUND = 1u;static inline const unsigned int e_DUPLICATE = 2u;static inline const unsigned int e_INVALID = 3u;template <typename T1, typename T2>
static bsl::pair<unsigned int, bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>>> bde_next(const bsl::shared_ptr<SkipNode<T1, T2>> pair){bsl::optional<bsl::shared_ptr<SkipNode<T1, T2>>> nextOpt = SkipList<int, int>::template next<T1,
T2>(pair);
...
static SkipList<T1, T2> create(const T1 dummyKey,
const T2 dummyVal){bsl::shared_ptr<SkipNode<T1, T2>> headNode = SkipNode<T1, T2>::create(dummyKey, dummyVal, (((16u - 1u) > 16u ? 0 : (16u - 1u))));
...
typename T2>
static SkipList<T1, T2> createIO(const T1 dummyKey,
