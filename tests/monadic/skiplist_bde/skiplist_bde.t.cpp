...
// UNIMPLEMENTED: manyThreadsRandomModesOnOneSkipListMain uses constructor with allocator parameter
/*
template <class KEY_TYPE, class DATA_TYPE>
...
// UNIMPLEMENTED: valueSemanticTest uses hexGg which uses addRaw, addAtLevelRaw, releaseReferenceRaw
/*
template <class KEY_TYPE, class DATA_TYPE>
...
// UNIMPLEMENTED: Raw pointer methods (skipForwardRaw, skipBackwardRaw, findRaw, etc.)
/*
template <class KEY_TYPE, class DATA_TYPE>
...
// UNIMPLEMENTED: newFrontTest uses update, frontRaw, releaseReferenceRaw, nextRaw, ->key()
/*
template <class KEY_TYPE, class DATA_TYPE>
...
// UNIMPLEMENTED: RemoveAllSafetyTest uses bsltf::AllocTestType which is not nothrow move constructible
                         ...
                         u::AddMode  mode)
{
    ...
    for (int ii = 0; ii < numIterations; ++ii) {
        ...
        switch (mode) {
          ...
          case u::e_ADD_AT_LEVEL_UNIQUE_RAW_PAIR: {
            int rc = list->addUnique(&ph, key, data);  // No level parameter in compat wrapper
            ASSERT(!!ph == !rc);
            collisions += !!rc;
          } break;
          case u::e_ADD_AT_LEVEL_UNIQUE_RAW_R_PAIR: {
            int rc = list->addUniqueR(&ph, key, data);  // No level parameter in compat wrapper
            ASSERT(!!ph == !rc);
            collisions += !!rc;
          } break;
          case u::e_ADD_UNIQUE: {
        ...
        // UNIMPLEMENTED: Raw pointer handling and vector-based removeAll removed
...
// UNIMPLEMENTED: frontRaw, addPairReferenceRaw, releaseReferenceRaw not supported
/*
...
///- - - - - - - - - - - - - - - -
// The "R" methods of `bdlcc_compat::SkipList` make it ideal for use in a scheduler,
...
// simple scheduler class using `bdlcc_compat::SkipList`.  Note that the mutex in the
// scheduler is used only in connection with the scheduler's condition variable
// - thread-safe access to the `bdlcc_compat::SkipList` object does *not* require any
// synchronization.
//
// ```
...
/// `list`.
void case16Produce (bdlcc_compat::SkipList<int, int> *list, bsls::AtomicInt *done)
{
    int count = 0;
    while (!(*done)) {
        if (0 > ++count) {
...
/// `list`.
void case16Consume(bdlcc_compat::SkipList<int, int> *list, bsls::AtomicInt *done)
{
    while (!(*done)) {
...
// UNIMPLEMENTED: frontRaw, ->key(), skipForwardRaw, releaseReferenceRaw not supported
/*
...
// UNIMPLEMENTED: findRaw, findRRaw, findLowerBoundRaw, findLowerBoundRRaw, findUpperBoundRaw, findUpperBoundRRaw, frontRaw, backRaw, nextRaw, previousRaw, skipForwardRaw, skipBackwardRaw, update, updateR, releaseReferenceRaw
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 31: {
        ...
        // UNIMPLEMENTED: ThrashFunctor uses Raw methods (addRaw, addUniqueRaw, etc.)
        /*
      ...
      // UNIMPLEMENTED: Case 27 uses manyThreadsRandomModesOnOneSkipListMain which uses constructor with allocator parameter
      /* case 27: {
        // --------------------------------------------------------------------
        // THOROUGH MULTI-THREADED ADD TEST
        //
...
// UNIMPLEMENTED: valueSemanticTest() -                         U_TEST_TYPES_REGULAR);
      ...
      // UNIMPLEMENTED: Case 26 uses test functions that use constructor with allocator parameter
      /* case 26: {
        // --------------------------------------------------------------------
...
// UNIMPLEMENTED: valueSemanticTest() -                         U_TEST_TYPES_REGULAR);
      ...
      //
      //   bdlcc_compat::SkipList<Test::KeyValue, Test::KeyValue> sl;    (void) sl;
      // } break;
      ...
      //   P(ta.numBytesMax());
      // } break;
      // UNIMPLEMENTED: Case 23 uses allocator() accessor and constructor with allocator parameter
      // case 23: {
      //   // --------------------------------------------------------------------
...
// UNIMPLEMENTED: valueSemanticTest() -         U_RUN_EACH_TYPE(TestDriver,
// UNIMPLEMENTED: valueSemanticTest() -                         valueSemanticTest,
// UNIMPLEMENTED: valueSemanticTest() -                         U_TEST_TYPES_REGULAR);

// UNIMPLEMENTED: valueSemanticTest() -         TestDriver<int, TTF::MethodPtr>::valueSemanticTest();
// UNIMPLEMENTED: valueSemanticTest() -         TestDriver<int, bsltf::AllocTestType>::valueSemanticTest();
// UNIMPLEMENTED: valueSemanticTest() -         TestDriver<int, bsltf::MovableAllocTestType>::valueSemanticTest();
// UNIMPLEMENTED: valueSemanticTest() -         TestDriver<int, bsltf::SimpleTestType>::valueSemanticTest();
      }  break;
      case 17: {
        // --------------------------------------------------------------------
...
/*       case 15: {
      ...
      // UNIMPLEMENTED: Case 14 uses CountedDelete which is not nothrow move constructible
      /* case 14: {
        // ------------------------------------
        // `remove` test
        // ------------------------------------
...
// UNIMPLEMENTED: Case 2 - STM incompatibility -         // --------------------------------------------------------------------
// UNIMPLEMENTED: Case 2 - STM incompatibility -
// UNIMPLEMENTED: Case 2 - STM incompatibility -         if (verbose) cout << endl
// UNIMPLEMENTED: Case 2 - STM incompatibility -                           << "Usage Example" << endl
// UNIMPLEMENTED: Case 2 - STM incompatibility -                           << "=============" << endl;
// UNIMPLEMENTED: Case 2 - STM incompatibility -
// UNIMPLEMENTED: Case 2 - STM incompatibility -         ASSERT(0 == completionGuard.guard(bsls::TimeInterval(270, 0),
// UNIMPLEMENTED: Case 2 - STM incompatibility -                                           bsl::format("case {}", test)));
// UNIMPLEMENTED: Case 2 - STM incompatibility -
// UNIMPLEMENTED: Case 2 - STM incompatibility -         using namespace USAGE;
// UNIMPLEMENTED: Case 2 - STM incompatibility -
// UNIMPLEMENTED: Case 2 - STM incompatibility -         {
// UNIMPLEMENTED: Case 2 - STM incompatibility - // ```
// UNIMPLEMENTED: Case 2 - STM incompatibility - // Now, in `main`, verify that the scheduler executes events when expected:
// UNIMPLEMENTED: Case 2 - STM incompatibility - // ```
// UNIMPLEMENTED: Case 2 - STM incompatibility -     SimpleScheduler      scheduler;
// UNIMPLEMENTED: Case 2 - STM incompatibility -
// UNIMPLEMENTED: Case 2 - STM incompatibility -     bsl::vector<int>     values;
// UNIMPLEMENTED: Case 2 - STM incompatibility -
// UNIMPLEMENTED: Case 2 - STM incompatibility -     const bdlt::Datetime start = bdlt::CurrentTime::utc();
// UNIMPLEMENTED: Case 2 - STM incompatibility -     bdlt::Datetime       scheduleTime;
// UNIMPLEMENTED: Case 2 - STM incompatibility - // ```
// UNIMPLEMENTED: Case 2 - STM incompatibility - // Add events out of sequence and ensure they are executed in the proper order.
// UNIMPLEMENTED: Case 2 - STM incompatibility - // ```
// UNIMPLEMENTED: Case 2 - STM incompatibility - if (veryVerbose) cout << "Start:      " << start << endl;
// UNIMPLEMENTED: Case 2 - STM incompatibility -
// UNIMPLEMENTED: Case 2 - STM incompatibility -     scheduleTime = start;
// UNIMPLEMENTED: Case 2 - STM incompatibility -     scheduleTime.addMilliseconds(2250);
// UNIMPLEMENTED: Case 2 - STM incompatibility - if (veryVerbose) cout << "scheduling: " << scheduleTime << endl;
// UNIMPLEMENTED: Case 2 - STM incompatibility -     scheduler.scheduleEvent(bdlf::BindUtil::bind(&pushBackWrapper, &values, 2),
// UNIMPLEMENTED: Case 2 - STM incompatibility -                             scheduleTime);
// UNIMPLEMENTED: Case 2 - STM incompatibility -
// UNIMPLEMENTED: Case 2 - STM incompatibility -     scheduleTime = start;
// UNIMPLEMENTED: Case 2 - STM incompatibility -     scheduleTime.addMilliseconds(750);
// UNIMPLEMENTED: Case 2 - STM incompatibility - if (veryVerbose) cout << "scheduling: " << scheduleTime << endl;
// UNIMPLEMENTED: Case 2 - STM incompatibility -     scheduler.scheduleEvent(bdlf::BindUtil::bind(&pushBackWrapper, &values, 0),
// UNIMPLEMENTED: Case 2 - STM incompatibility -                             scheduleTime);
// UNIMPLEMENTED: Case 2 - STM incompatibility -
// UNIMPLEMENTED: Case 2 - STM incompatibility -     scheduleTime = start;
// UNIMPLEMENTED: Case 2 - STM incompatibility -     scheduleTime.addMilliseconds(1500);
// UNIMPLEMENTED: Case 2 - STM incompatibility - if (veryVerbose) cout << "scheduling: " << scheduleTime << endl;
// UNIMPLEMENTED: Case 2 - STM incompatibility -     scheduler.scheduleEvent(bdlf::BindUtil::bind(&pushBackWrapper, &values, 1),
// UNIMPLEMENTED: Case 2 - STM incompatibility -                             scheduleTime);
// UNIMPLEMENTED: Case 2 - STM incompatibility -
...
// UNIMPLEMENTED: Case 2 - STM incompatibility -
// UNIMPLEMENTED: Case 2 - STM incompatibility -     bdlt::Datetime finish = bdlt::CurrentTime::utc();
// UNIMPLEMENTED: Case 2 - STM incompatibility - if (veryVerbose) cout << "Finish:     " << finish << endl;
// UNIMPLEMENTED: Case 2 - STM incompatibility -
// UNIMPLEMENTED: Case 2 - STM incompatibility -     ASSERT(3 == values.size());
// UNIMPLEMENTED: Case 2 - STM incompatibility -     ASSERT(0 == values[0]);
// UNIMPLEMENTED: Case 2 - STM incompatibility -     ASSERT(1 == values[1]);
// UNIMPLEMENTED: Case 2 - STM incompatibility -     ASSERT(2 == values[2]);
// UNIMPLEMENTED: Case 2 - STM incompatibility -
// UNIMPLEMENTED: Case 2 - STM incompatibility -     const double elapsed = bdlt::IntervalConversionUtil::convertToTimeInterval(
// UNIMPLEMENTED: Case 2 - STM incompatibility -                                         finish - start).totalSecondsAsDouble();
// UNIMPLEMENTED: Case 2 - STM incompatibility -
// UNIMPLEMENTED: Case 2 - STM incompatibility -     ASSERT(2.25 <= elapsed);
// UNIMPLEMENTED: Case 2 - STM incompatibility -     ASSERT(elapsed < 2.75);
// UNIMPLEMENTED: Case 2 - STM incompatibility -
// UNIMPLEMENTED: Case 2 - STM incompatibility - if (veryVerbose) cout << "Elapsed: " << elapsed << " seconds\n";
// UNIMPLEMENTED: Case 2 - STM incompatibility - // ```
// UNIMPLEMENTED: Case 2 - STM incompatibility - // Note that the destructor of `scheduler` will call `stop()`.
// UNIMPLEMENTED: Case 2 - STM incompatibility - // ```
// UNIMPLEMENTED: Case 2 - STM incompatibility -         }
// UNIMPLEMENTED: Case 2 - STM incompatibility -       } break;
      case 1: {
...

        {
            ...
            // UNIMPLEMENTED: popFrontRaw, ->data(), releaseReferenceRaw, ->key() not supported
            /*
            Obj::Pair *h = 0;
...
//
// UNIMPLEMENTED: bsl::string is not nothrow swappable for STM
//             // UNIMPLEMENTED: popFrontRaw, ->data(), ->key(), releaseReferenceRaw not supported
// UNIMPLEMENTED: bsl::string is not nothrow swappable for STM
//             /*
// UNIMPLEMENTED: bsl::string is not nothrow swappable for STM
//             Obj2::Pair *h2 = 0;
...
// UNIMPLEMENTED: bsl::string section -             ret = mX2.popFront(&h2h);
// UNIMPLEMENTED: bsl::string section -             ASSERT(ret == Obj::e_NOT_FOUND);
        }
      } break;
      case -105: {
        // --------------------------------------------------------------------
