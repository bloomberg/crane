...
struct CHT {
    ...
    bsl::vector<bsl::shared_ptr<
        stm::TVar<bsl::shared_ptr<List<bsl::pair<K, V> > > > > >
                              cht_buckets;
    ...
    bsl::optional<V> stm_delete(const K k) const
    {
        ...
        bsl::shared_ptr<List<bsl::pair<K, V> > > xs =
                   stm::readTVar<bsl::shared_ptr<List<bsl::pair<K, V> > > >(b);
        bsl::pair<bsl::optional<V>, bsl::shared_ptr<List<bsl::pair<K, V> > > >
            p = CHT<int, int>::template assoc_remove<K, V>(this->CHT::cht_eqb,
                                                           k,
                                                           xs);
        if (p.first.has_value()) {
            V _x = *p.first;
            stm::writeTVar<bsl::shared_ptr<List<bsl::pair<K, V> > > >(
                                                                     b,
                                                                     p.second);
            return p.first;
        }
    ...
    mk_buckets(const int64_t num)
    {
        ...
        bsl::function<bsl::vector<bsl::shared_ptr<stm::TVar<
            bsl::shared_ptr<List<bsl::pair<T1, T2> > > > > >(unsigned int)>
            f;
        f = [&](unsigned int n)
            -> bsl::vector<bsl::shared_ptr<
                stm::TVar<bsl::shared_ptr<List<bsl::pair<T1, T2> > > > > > {
