...
void threadtest::fun1(unsigned int n) {
  if (n <= 0) {
...
void threadtest::fun2(unsigned int n) {
  if (n <= 0) {
...
void threadtest::test(unsigned int m, unsigned int n) {
...
void threadtest::test_pure(unsigned int m, unsigned int n) {
  test(m, n);
  return;
}
