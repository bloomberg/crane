#ifndef INCLUDED_PROMOTED_VAR_OF_SPECIALISED_INSTANCE_ARGUMENT
#define INCLUDED_PROMOTED_VAR_OF_SPECIALISED_INSTANCE_ARGUMENT
...
#endif // INCLUDED_PROMOTED_VAR_OF_SPECIALISED_INSTANCE_ARGUMENT
