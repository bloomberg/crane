...
unsigned int AnonFixpoint::sum_to(unsigned int n) {
...
unsigned int AnonFixpoint::factorial(unsigned int m) {
  if (m <= 0) {
    return 1u;
  } else {
    unsigned int p = m - 1;
...
unsigned int AnonFixpoint::double_sum(unsigned int m) {
  if (m <= 0) {
    return 0u;
  } else {
    unsigned int p = m - 1;
...
unsigned int AnonFixpoint::gcd(unsigned int a, unsigned int b) {
...
unsigned int AnonFixpoint::test_shadow(unsigned int n) {
