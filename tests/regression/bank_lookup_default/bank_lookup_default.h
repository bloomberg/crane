...
struct BankLookupDefault {
  struct ram_chip {
    ...
    __attribute__((pure)) ram_chip clone() const {
      return ram_chip{clone_as_value<unsigned int>((*(this)).chip_port)};
    }
  };
