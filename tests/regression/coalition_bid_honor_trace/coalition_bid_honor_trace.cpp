      ...
      Overloaded{
          [](const typename List<std::shared_ptr<
            ...
            return List<std::shared_ptr<
                CoalitionBidHonorTraceCase::CoalitionMember>>::ctor::Nil_();
          },
          [&](const typename List<std::shared_ptr<
            ...
            if (idx <= 0) {
              return List<std::shared_ptr<
                  CoalitionBidHonorTraceCase::CoalitionMember>>::ctor::
                  Cons_(std::make_shared<
                            CoalitionBidHonorTraceCase::CoalitionMember>(
...
CoalitionBidHonorTraceCase::valid_coalition_member_bid_b(
    ...
    const std::shared_ptr<CoalitionBidHonorTraceCase::CoalitionMemberBid>
        &cbid) {
  return (
      PeanoNat::ltb(cbid->cmb_member_index, c->length()) &&
      metrics_total_lt(
...
__attribute__((pure)) bool CoalitionBidHonorTraceCase::is_terminal(
    const std::shared_ptr<CoalitionBidHonorTraceCase::BatchallPhase> &phase) {
  return std::visit(
      Overloaded{
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::PhaseIdle
                 _args) -> bool { return false; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseChallenged _args) -> bool { return false; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseResponded _args) -> bool { return false; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseBidding _args) -> bool { return false; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseAgreed _args) -> bool { return true; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseRefused _args) -> bool { return true; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseAborted _args) -> bool { return true; }},
      phase->v());
}

__attribute__((pure)) bool CoalitionBidHonorTraceCase::is_bidding(
    const std::shared_ptr<CoalitionBidHonorTraceCase::BatchallPhase> &phase) {
  return std::visit(
      Overloaded{
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::PhaseIdle
          ...
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseResponded _args) -> bool { return false; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseBidding _args) -> bool { return true; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseAgreed _args) -> bool { return false; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseRefused _args) -> bool { return false; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseAborted _args) -> bool { return false; }},
      phase->v());
}

__attribute__((pure)) unsigned int CoalitionBidHonorTraceCase::phase_depth(
    const std::shared_ptr<CoalitionBidHonorTraceCase::BatchallPhase> &phase) {
  return std::visit(
      Overloaded{
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::PhaseIdle
                 _args) -> unsigned int { return 4u; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseChallenged _args) -> unsigned int { return 3u; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseResponded _args) -> unsigned int { return 2u; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseBidding _args) -> unsigned int { return 1u; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseAgreed _args) -> unsigned int { return 0u; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseRefused _args) -> unsigned int { return 0u; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseAborted _args) -> unsigned int { return 0u; }},
      phase->v());
}

__attribute__((pure)) unsigned int
CoalitionBidHonorTraceCase::get_bidding_measure(
    const std::shared_ptr<CoalitionBidHonorTraceCase::BatchallPhase> &phase) {
  return std::visit(
      Overloaded{
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::PhaseIdle
          ...
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseChallenged _args) -> unsigned int { return 0u; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseResponded _args) -> unsigned int { return 0u; },
          [](const typename CoalitionBidHonorTraceCase::BatchallPhase::
                 PhaseBidding _args) -> unsigned int {
  ...
  return std::visit(
      Overloaded{
          [&](const typename List<
            ...
            return List<std::pair<unsigned int, std::shared_ptr<Z>>>::ctor::
                Cons_(
                    std::make_pair(std::move(warrior_id), std::move(new_honor)),
                    List<std::pair<unsigned int,
                                   std::shared_ptr<Z>>>::ctor::Nil_());
          },
          [&](const typename List<
              std::pair<unsigned int, std::shared_ptr<Z>>>::Cons _args)
              -> std::shared_ptr<
            ...
            if (PeanoNat::eqb(id, warrior_id)) {
              return List<std::pair<unsigned int, std::shared_ptr<Z>>>::ctor::
                  Cons_(std::make_pair(id, new_honor), std::move(_args.d_a1));
            } else {
              return List<std::pair<unsigned int, std::shared_ptr<Z>>>::ctor::
                  Cons_(std::make_pair(id, honor),
  ...
  return std::visit(
      Overloaded{
          ...
          [](const typename CoalitionBidHonorTraceCase::ProtocolAction::ActBid
                 _args) -> std::shared_ptr<Z> { return Z::ctor::Z0_(); },
          [](const typename CoalitionBidHonorTraceCase::ProtocolAction::
          ...
          [](const typename CoalitionBidHonorTraceCase::ProtocolAction::
            ...
            return Z::ctor::Zneg_(Positive::ctor::XO_(Positive::ctor::XH_()));
          },
          [](const typename CoalitionBidHonorTraceCase::ProtocolAction::
                 ActBreakBid _args) -> std::shared_ptr<Z> {
            return Z::ctor::Zneg_(Positive::ctor::XO_(Positive::ctor::XI_(
...
__attribute__((pure))
std::optional<std::shared_ptr<CoalitionBidHonorTraceCase::Commander>>
CoalitionBidHonorTraceCase::get_side_commander(
    const std::shared_ptr<CoalitionBidHonorTraceCase::BatchallPhase> &phase,
    const CoalitionBidHonorTraceCase::Side side) {
  return std::visit(
      Overloaded{
...
__attribute__((pure))
std::optional<std::shared_ptr<CoalitionBidHonorTraceCase::Commander>>
CoalitionBidHonorTraceCase::action_actor_in_phase(
    const std::shared_ptr<CoalitionBidHonorTraceCase::BatchallPhase> &phase,
    const std::shared_ptr<CoalitionBidHonorTraceCase::ProtocolAction> &action) {
  return std::visit(
      Overloaded{
          ...
          [&](const typename CoalitionBidHonorTraceCase::ProtocolAction::
              ...
              -> std::optional<
                  std::shared_ptr<CoalitionBidHonorTraceCase::Commander>> {
            return get_side_commander(phase, _args.d_a0);
          },
          [&](const typename CoalitionBidHonorTraceCase::ProtocolAction::
                  ActBreakBid _args)
              -> std::optional<
...
CoalitionBidHonorTraceCase::apply_action_honor(
    ...
    const std::shared_ptr<CoalitionBidHonorTraceCase::ProtocolAction> &action) {
  if (action_actor_in_phase(state->bs_phase, action).has_value()) {
    std::shared_ptr<CoalitionBidHonorTraceCase::Commander> actor =
        *action_actor_in_phase(state->bs_phase, action);
