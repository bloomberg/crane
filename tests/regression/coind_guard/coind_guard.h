...
struct CoindGuard {
  ...
  public:
    ...
    cons(t_A a0, const std::shared_ptr<Stream<t_A>> &a1) {
      return std::make_shared<Stream<t_A>>(Cons{std::move(a0), a1});
    }

    static std::shared_ptr<Stream<t_A>>
    cons(t_A a0, std::shared_ptr<Stream<t_A>> &&a1) {
    ...
    cons_uptr(t_A a0, const std::shared_ptr<Stream<t_A>> &a1) {
      return std::make_unique<Stream<t_A>>(Cons{std::move(a0), a1});
    }

    static std::unique_ptr<Stream<t_A>>
    cons_uptr(t_A a0, std::shared_ptr<Stream<t_A>> &&a1) {
      return std::make_unique<Stream<t_A>>(Cons{std::move(a0), std::move(a1)});
    }
  ...
  static std::shared_ptr<Stream<T3>> zipWith(F0 &&f,
    ...
    return Stream<T3>::lazy_([=](void) mutable -> std::shared_ptr<Stream<T3>> {
  ...
  static std::shared_ptr<Stream<T2>> smap(F0 &&f,
    ...
    return Stream<T2>::lazy_([=](void) mutable -> std::shared_ptr<Stream<T2>> {
