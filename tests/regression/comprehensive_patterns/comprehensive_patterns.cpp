...
ComprehensivePatterns::syntactic_variation(
  ...
  std::function<unsigned int(std::shared_ptr<ComprehensivePatterns::S>)> b =
      [](std::shared_ptr<ComprehensivePatterns::S> s0) { return s0->s_b; };
...
ComprehensivePatterns::compose(std::shared_ptr<ComprehensivePatterns::S> s) {
  std::function<unsigned int(std::shared_ptr<ComprehensivePatterns::S>)> f =
      [](std::shared_ptr<ComprehensivePatterns::S> x) { return x->s_a; };
...
ComprehensivePatterns::match_pair(
    const std::pair<std::shared_ptr<ComprehensivePatterns::S>, unsigned int>
        p) {
  std::shared_ptr<ComprehensivePatterns::S> s = p.first;
  unsigned int n = p.second;
...
ComprehensivePatterns::multi_match(
  ...
  if (o1.has_value()) {
    std::shared_ptr<ComprehensivePatterns::S> s1 = *o1;
    if (o2.has_value()) {
      std::shared_ptr<ComprehensivePatterns::S> _x = *o2;
...
ComprehensivePatterns::option_proj(
  ...
  if (o.has_value()) {
    std::shared_ptr<ComprehensivePatterns::R2> r2 = *o;
    return std::make_optional<
        std::pair<std::shared_ptr<ComprehensivePatterns::R2>,
                  std::shared_ptr<ComprehensivePatterns::R1>>>(
...
__attribute__((pure)) unsigned int ComprehensivePatterns::option_unwrap_proj(
  ...
  if (o.has_value()) {
    std::shared_ptr<ComprehensivePatterns::R> r = *o;
    return (r->val + r->dat);
  } else {
    return 0u;
  }
...
__attribute__((pure)) unsigned int ComprehensivePatterns::nested_match(
  ...
  if (o1.has_value()) {
    std::shared_ptr<ComprehensivePatterns::R> r1 = *o1;
    if (o2.has_value()) {
      std::shared_ptr<ComprehensivePatterns::R> r2 = *o2;
...
ComprehensivePatterns::both_proj(std::shared_ptr<ComprehensivePatterns::R> r) {
...
__attribute__((pure)) unsigned int ComprehensivePatterns::compose_proj(
  ...
  std::function<unsigned int(std::shared_ptr<ComprehensivePatterns::R>)> f =
      [](std::shared_ptr<ComprehensivePatterns::R> x) { return x->val; };
  std::function<unsigned int(std::shared_ptr<ComprehensivePatterns::R>)> g =
      [](std::shared_ptr<ComprehensivePatterns::R> x) { return x->dat; };
  return (f(r) + g(r));
}
  ...
  while (!_stack.empty()) {
    ...
    std::visit(Overloaded{[&](_Enter _f) {
                            ...
                            if (n <= 0) {
                              ...
                              unsigned int m = n - 1;
                              _stack.push_back(_Call1{r->nc_b});
  ...
  while (!_stack.empty()) {
    ...
    std::visit(Overloaded{[&](_Enter _f) {
                            ...
                            if (n <= 0) {
                              ...
                              unsigned int m = n - 1;
                              _stack.push_back(_Call1{r->nc_a});
                              _stack.push_back(_Enter{m});
                            }
                          },
...
__attribute__((pure)) unsigned int ComprehensivePatterns::hof_test(
    const std::shared_ptr<ComprehensivePatterns::NC> &r) {
  return apply(
      [](std::shared_ptr<ComprehensivePatterns::NC> x) {
...
ComprehensivePatterns::return_pair(
    std::shared_ptr<ComprehensivePatterns::StateStmt> s) {
  ...
  while (!_stack.empty()) {
    ...
    std::visit(Overloaded{[&](_Enter _f) {
                            ...
                            if (n <= 0) {
                              ...
                              unsigned int m = n - 1;
                              _stack.push_back(_Call1{s->stmt_value});
                              _stack.push_back(_Enter{m});
                            }
                          },
                          [&](_Call1 _f) { _result = (_f._s0 + _result); }},
...
__attribute__((pure)) unsigned int ComprehensivePatterns::match_with_wild(
  ...
  if (o.has_value()) {
    std::shared_ptr<ComprehensivePatterns::RCF> r = *o;
    return r->cf_val;
  } else {
    return 0u;
  }
  ...
  while (!_stack.empty()) {
    ...
    std::visit(Overloaded{[&](_Enter _f) {
                            ...
                            if (n <= 0) {
                              ...
                              unsigned int m = n - 1;
                              _stack.push_back(_Call1{r->cf_val});
                              _stack.push_back(_Enter{m});
                            }
                          },
                          [&](_Call1 _f) { _result = (_f._s0 + _result); }},
  ...
  while (!_stack.empty()) {
    ...
    std::visit(Overloaded{[&](_Enter _f) {
                            ...
                            if (n <= 0) {
                              ...
                              unsigned int m = n - 1;
                              _stack.push_back(_Call1{s->lb_value});
                              _stack.push_back(_Enter{m});
                            }
                          },
                          [&](_Call1 _f) { _result = (_f._s0 + _result); }},
