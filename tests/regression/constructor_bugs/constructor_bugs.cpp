...
std::pair<std::pair<ConstructorBugs::state, ConstructorBugs::state>,
          unsigned int>
ConstructorBugs::tuple_from_call(unsigned int n) {
  ConstructorBugs::state s = get_state(n);
  return std::make_pair(std::make_pair(s, s), s.value);
}

std::pair<std::pair<ConstructorBugs::state, unsigned int>,
...
ConstructorBugs::conditional_tuple(bool b, unsigned int n) {
  ConstructorBugs::state s = get_state(n);
  if (b) {
...
unsigned int ConstructorBugs::extract_value(const ConstructorBugs::state &s) {
  return s.value;
}
...
std::pair<std::pair<ConstructorBugs::state, unsigned int>, List<unsigned int>>
ConstructorBugs::multi_call_tuple(unsigned int n) {
  ConstructorBugs::state s = get_state(n);
...
std::pair<ConstructorBugs::state, unsigned int>
ConstructorBugs::outer_call(unsigned int n) {
...
std::pair<ConstructorBugs::Inner, unsigned int>
ConstructorBugs::pair_from_func(unsigned int n) {
...
std::pair<List<ConstructorBugs::Inner>, unsigned int>
...
unsigned int ConstructorBugs::extract(const ConstructorBugs::Inner &i) {
  return i.inner_val;
}
...
std::pair<ConstructorBugs::State, unsigned int>
ConstructorBugs::inline_from_call(unsigned int n) {
  return std::make_pair(get_state_inline(n), get_state_inline(n).value_inline);
}

std::pair<std::pair<ConstructorBugs::State, unsigned int>, unsigned int>
ConstructorBugs::same_call_multi_proj(unsigned int n) {
  return std::make_pair(
...
ConstructorBugs::inline_recursive(unsigned int n, ConstructorBugs::State s) {
  if (n <= 0) {
...
unsigned int ConstructorBugs::get_data_inline(const ConstructorBugs::State &s) {
