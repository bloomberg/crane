...
std::optional<unsigned int> CustomInlineBug::bug_some_of_call(unsigned int n) {
...
std::pair<std::pair<CustomInlineBug::State, unsigned int>,
...
CustomInlineBug::count_pairs(unsigned int n, CustomInlineBug::State s) {
  if (n <= 0) {
