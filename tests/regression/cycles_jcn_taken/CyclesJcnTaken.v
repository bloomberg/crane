...
(* Behavioral candidate: JCN cycle count is 16 when branch is taken. *)

From Stdlib Require Import Nat Bool.

Module CyclesJcnTaken.
...
Definition t : nat := cycles (mkState 0 false false) (JCN 4 7).

End CyclesJcnTaken.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "cycles_jcn_taken" CyclesJcnTaken.
