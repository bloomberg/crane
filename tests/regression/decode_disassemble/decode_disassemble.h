...
struct DecodeDisassemble {
  ...
  static inline const unsigned int test_disassemble_opcode_0 = [](void) {
    if (disassemble(
  ...
  static inline const unsigned int test_disassemble_alternative = [](void) {
    if (disassemble(
            List<unsigned int>::ctor::cons_(
                0u,
                List<unsigned int>::ctor::cons_(
