#ifndef INCLUDED_DEP_RETURN_ANY_CAST
#define INCLUDED_DEP_RETURN_ANY_CAST
...
struct DepReturnAnyCast {
  ...
  static std::any dep(bool b);
  static uint64_t run(uint64_t k);
};

#endif // INCLUDED_DEP_RETURN_ANY_CAST
