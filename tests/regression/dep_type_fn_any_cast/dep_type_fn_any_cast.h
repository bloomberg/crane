#ifndef INCLUDED_DEP_TYPE_FN_ANY_CAST
#define INCLUDED_DEP_TYPE_FN_ANY_CAST
...
struct DepTypeFnAnyCast {
  ...
  using dt = std::any;
  static dt mk(uint64_t n);
  static uint64_t run(uint64_t k);
};

#endif // INCLUDED_DEP_TYPE_FN_ANY_CAST
