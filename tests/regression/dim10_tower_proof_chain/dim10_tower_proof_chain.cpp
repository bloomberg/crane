...
unsigned int Dim10TowerProofChainCase::poly_approx_dim(const unsigned int _x0,
                                                       const unsigned int _x1) {
  return nat_sub(_x0, _x1);
}

unsigned int Dim10TowerProofChainCase::layer_dim(const unsigned int base_dim,
