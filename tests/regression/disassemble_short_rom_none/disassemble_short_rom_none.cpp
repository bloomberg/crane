...
#include <any>
#include <cassert>
#include <disassemble_short_rom_none.h>
#include <functional>
#include <iostream>
#include <memory>
#include <optional>
...
std::shared_ptr<DisassembleShortRomNone::instruction>
DisassembleShortRomNone::decode(const unsigned int b1, const unsigned int b2) {
  if ((b1 == 0)) {
...
std::optional<std::pair<std::shared_ptr<DisassembleShortRomNone::instruction>,
                        unsigned int>>
DisassembleShortRomNone::disassemble(
                    ...
                    [](const typename List<unsigned int>::nil _args)
                        -> std::optional<
                            std::pair<std::shared_ptr<
                                          DisassembleShortRomNone::instruction>,
                                      unsigned int>> { return std::nullopt; },
                    [&](const typename List<unsigned int>::cons _args)
                        -> std::optional<
                            std::pair<std::shared_ptr<
