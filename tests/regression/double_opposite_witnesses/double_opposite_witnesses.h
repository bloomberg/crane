...
struct DoubleOppositeWitnessesCase {
  ...
  public:
    ...
    __attribute__((pure)) Path<_CloneT0> clone_as() const {
      return Path<_CloneT0>(typename Path<_CloneT0>::Path_refl{});
    }
  ...
  struct Functor {
    ...
    __attribute__((pure)) Functor clone() const {
      return Functor{clone_value((*(this)).object_of),
                     clone_value((*(this)).morphism_of)};
    }
  };
