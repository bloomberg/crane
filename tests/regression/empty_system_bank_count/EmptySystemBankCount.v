...
(* Behavioral candidate: empty RAM system allocates NBANKS banks. *)

From Stdlib Require Import List Nat.
Import ListNotations.

Module EmptySystemBankCount.
...
Definition empty_sys : list ram_bank := repeat empty_bank NBANKS.

Definition t : nat := length empty_sys.

End EmptySystemBankCount.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "empty_system_bank_count" EmptySystemBankCount.
