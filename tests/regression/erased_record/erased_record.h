...
struct ErasedRecord {
  struct ManyProps {
    ...
    __attribute__((pure)) ManyProps clone() const {
      return ManyProps{clone_as_value<unsigned int>((*(this)).field0),
                       clone_as_value<unsigned int>((*(this)).field1),
                       clone_as_value<unsigned int>((*(this)).field2),
                       clone_as_value<unsigned int>((*(this)).field3),
                       clone_as_value<unsigned int>((*(this)).field4)};
    }
  };
  ...
  struct MostlyProps {
    ...
    __attribute__((pure)) MostlyProps clone() const {
      return MostlyProps{clone_as_value<unsigned int>((*(this)).real1),
                         clone_as_value<unsigned int>((*(this)).real2),
                         clone_as_value<unsigned int>((*(this)).real3)};
    }
  };
