...
struct ExtractDirectives {
  ...
  static unsigned int transform(const unsigned int &base,
  ...
  static unsigned int inner_add(const unsigned int &_x0,
                                const unsigned int &_x1);
  static unsigned int inner_mul(const unsigned int &_x0,
                                const unsigned int &_x1);
