#ifndef INCLUDED_FILE_EPONYMOUS_WITH_ALIAS
...
struct FileEponymousWithAlias {
  static inline const List<Nat> use = DList0::template DList_append<Nat>(
      DList0::template DList_empty<Nat>(), DList0::template DList_empty<Nat>())(
