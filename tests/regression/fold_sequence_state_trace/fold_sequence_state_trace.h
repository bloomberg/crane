...
struct FoldSequenceStateTraceCase {
  ...
  struct Line {
    ...
    __attribute__((pure)) Line clone() const {
      return Line{clone_as_value<Real>((*(this)).A),
                  clone_as_value<Real>((*(this)).B),
                  clone_as_value<Real>((*(this)).C)};
    }
  };
  ...
  struct ConstructionState {
    ...
    __attribute__((pure)) ConstructionState clone() const {
      return ConstructionState{
          clone_as_value<List<Point>>((*(this)).state_points),
          clone_as_value<List<Line>>((*(this)).state_lines)};
    }
  };
