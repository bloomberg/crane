...
struct GetPairBoundProp {
  ...
  struct state {
    ...
    __attribute__((pure)) state clone() const {
      return state{clone_as_value<unsigned int>((*(this)).ex_acc),
                   clone_as_value<List<unsigned int>>((*(this)).ex_regs),
                   clone_as_value<bool>((*(this)).ex_carry),
                   clone_as_value<unsigned int>((*(this)).ex_pc),
                   clone_as_value<List<unsigned int>>((*(this)).ex_stack),
                   clone_as_value<unsigned int>((*(this)).ex_pair_bus),
                   clone_as_value<List<unsigned int>>((*(this)).ex_ports)};
    }
  };
