...
struct IszOps {
  ...
  struct state {
    ...
    // ACCESSORS
    __attribute__((pure)) state clone() const { return state{(*(this)).regs}; }
  };

  __attribute__((pure)) static unsigned int get_reg(const state &s,
                                                    const unsigned int &r);
  __attribute__((pure)) static unsigned int cycles_isz(const state &s,
                                                       const unsigned int &r);
  ...
  __attribute__((pure)) static bool isz_loops(const state &s,
                                              const unsigned int &r);
  __attribute__((pure)) static bool isz_terminates(const state &s,
                                                   const unsigned int &r);
