...
(* Behavioral candidate: JCN JNZ branch condition depends on nonzero accumulator. *)

From Stdlib Require Import Nat Bool.

Module JcnConditionNonzeroGate.
...
Definition t : bool := jcn_condition (mkState 3 false true) 12.

End JcnConditionNonzeroGate.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "jcn_condition_nonzero_gate" JcnConditionNonzeroGate.
