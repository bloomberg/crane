...
(* Behavioral candidate: JCN JT observes the inverted high test-pin path. *)

From Stdlib Require Import Nat Bool.

Module JcnConditionTestHigh.
...
Definition t : bool := jcn_condition (mkState 1 false true) 9.

End JcnConditionTestHigh.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "jcn_condition_test_high" JcnConditionTestHigh.
