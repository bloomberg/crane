...
(* Behavioral candidate: JCN JNT observes the test pin low path. *)

From Stdlib Require Import Nat Bool.

Module JcnConditionTestLow.
...
Definition t : bool := jcn_condition (mkState 1 false false) 1.

End JcnConditionTestLow.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "jcn_condition_test_low" JcnConditionTestLow.
