...
(* Behavioral candidate: JCN JZ branch condition depends on zero accumulator. *)

From Stdlib Require Import Nat Bool.

Module JcnConditionZeroGate.
...
Definition t : bool := jcn_condition (mkState 0 false true) 4.

End JcnConditionZeroGate.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "jcn_condition_zero_gate" JcnConditionZeroGate.
