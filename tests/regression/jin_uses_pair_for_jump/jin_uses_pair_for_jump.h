...
struct JinUsesPairForJump {
  struct state {
    ...
    __attribute__((pure)) state clone() const {
      return state{(*(this)).regs.clone(), (*(this)).pc};
    }
  };
  ...
  __attribute__((pure)) static unsigned int get_reg_pair(const state &s,
                                                         const unsigned int &r);
  __attribute__((pure)) static unsigned int page_of(const unsigned int &addr);
  __attribute__((pure)) static state execute_jin(const state &s,
                                                 const unsigned int &r);
