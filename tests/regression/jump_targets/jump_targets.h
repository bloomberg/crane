  ...
  public:
    ...
    __attribute__((pure)) instr_collection clone() const {
      ...
      if (std::holds_alternative<JUN_coll>(_sv.v())) {
        ...
        return instr_collection(JUN_coll{[](auto &&__v) -> unsigned int {
          if constexpr (
        ...
        return instr_collection(JMS_coll{[](auto &&__v) -> unsigned int {
          if constexpr (
              requires { __v ? 0 : 0; } && requires { *__v; } &&
              requires { __v->clone(); } && requires { __v.get(); }) {
            using _E = std::remove_cvref_t<decltype(*__v)>;
  ...
  public:
    ...
    __attribute__((pure)) instr_region clone() const {
      ...
      if (std::holds_alternative<JUN_reg>(_sv.v())) {
        ...
        return instr_region(JUN_reg{[](auto &&__v) -> unsigned int {
          if constexpr (
              requires { __v ? 0 : 0; } && requires { *__v; } &&
              requires { __v->clone(); } && requires { __v.get(); }) {
            using _E = std::remove_cvref_t<decltype(*__v)>;
        ...
        return instr_region(JMS_reg{[](auto &&__v) -> unsigned int {
          if constexpr (
              requires { __v ? 0 : 0; } && requires { *__v; } &&
              requires { __v->clone(); } && requires { __v.get(); }) {
            using _E = std::remove_cvref_t<decltype(*__v)>;
  ...
  public:
    ...
    __attribute__((pure)) instr_jms clone() const {
      ...
      if (std::holds_alternative<JUN_jms>(_sv.v())) {
        ...
        return instr_jms(JUN_jms{[](auto &&__v) -> unsigned int {
          if constexpr (
              requires { __v ? 0 : 0; } && requires { *__v; } &&
              requires { __v->clone(); } && requires { __v.get(); }) {
            using _E = std::remove_cvref_t<decltype(*__v)>;
        ...
        return instr_jms(JMS_jms{[](auto &&__v) -> unsigned int {
          if constexpr (
              requires { __v ? 0 : 0; } && requires { *__v; } &&
              requires { __v->clone(); } && requires { __v.get(); }) {
            using _E = std::remove_cvref_t<decltype(*__v)>;
  ...
  public:
    ...
    __attribute__((pure)) instr_jun clone() const {
      ...
      if (std::holds_alternative<JUN_jun>(_sv.v())) {
        ...
        return instr_jun(JUN_jun{[](auto &&__v) -> unsigned int {
          if constexpr (
              requires { __v ? 0 : 0; } && requires { *__v; } &&
              requires { __v->clone(); } && requires { __v.get(); }) {
            using _E = std::remove_cvref_t<decltype(*__v)>;
        ...
        return instr_jun(JMS_jun{[](auto &&__v) -> unsigned int {
          if constexpr (
              requires { __v ? 0 : 0; } && requires { *__v; } &&
              requires { __v->clone(); } && requires { __v.get(); }) {
            using _E = std::remove_cvref_t<decltype(*__v)>;
