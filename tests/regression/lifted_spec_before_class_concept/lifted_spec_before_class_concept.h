#ifndef INCLUDED_LIFTED_SPEC_BEFORE_CLASS_CONCEPT
...
template <Params _tcI0, typename T1> auto _walk_mk(const T1) {
...
struct LiftedSpecBeforeClassConcept {
  static inline const Tagged<Box<typename natParams::addr>> run =
      walk<natParams>(Nat::s(Nat::o()), Nat::o());
};

#endif // INCLUDED_LIFTED_SPEC_BEFORE_CLASS_CONCEPT
