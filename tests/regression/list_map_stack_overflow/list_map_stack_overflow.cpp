...
/// can overflow.
List<uint64_t> ListMapStackOverflow::bld(uint64_t n, List<uint64_t> acc) {
...
uint64_t ListMapStackOverflow::run(uint64_t k) {
  return bld((k + UINT64_C(200000)), List<uint64_t>::nil())
      .template map<uint64_t>([](uint64_t x) { return (x + UINT64_C(1)); })
