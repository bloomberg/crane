...
struct LoopifyExpr {
  ...
  public:
    ...
    __attribute__((pure)) unsigned int eval() const {
      ...
      while (!_stack.empty()) {
        ...
        if (std::holds_alternative<_Enter>(_frame)) {
          ...
          auto _f = std::move(std::get<_Call6>(_frame));
          std::unique_ptr<expr> d_a1 = _f._s0;
          std::unique_ptr<expr> d_a2 = _f._s1;
    ...
    template <
        ...
        MapsTo<T1, std::unique_ptr<expr>, T1> F1,
        MapsTo<T1, std::unique_ptr<expr>, T1, std::unique_ptr<expr>, T1> F2,
        MapsTo<T1, std::unique_ptr<expr>, T1, std::unique_ptr<expr>, T1> F3,
        MapsTo<T1, std::unique_ptr<expr>, T1, std::unique_ptr<expr>, T1,
  ...
  public:
    ...
    __attribute__((pure)) simple_expr clone() const {
      ...
      if (std::holds_alternative<Lit>(_sv.v())) {
        ...
        return simple_expr(Lit{clone_as_value<unsigned int>(d_a0)});
    ...
    __attribute__((pure)) unsigned int eval_simple() const {
      ...
      while (!_stack.empty()) {
        ...
        if (std::holds_alternative<_Enter>(_frame)) {
          ...
          auto _f = std::move(std::get<_Call3>(_frame));
          std::unique_ptr<simple_expr> d_a1 = _f._s0;
          std::unique_ptr<simple_expr> d_a2 = _f._s1;
          unsigned int _cond0 = _result;
          if (0u < _cond0) {
            _stack.emplace_back(_Enter{d_a1.get()});
          } else {
    ...
    template <typename T1, MapsTo<T1, unsigned int> F0,
              MapsTo<T1, std::unique_ptr<simple_expr>, T1,
                     std::unique_ptr<simple_expr>, T1>
                  F1,
              MapsTo<T1, std::unique_ptr<simple_expr>, T1,
                     std::unique_ptr<simple_expr>, T1,
                     std::unique_ptr<simple_expr>, T1>
  ...
  public:
    ...
    __attribute__((pure)) cond_expr clone() const {
      ...
      if (std::holds_alternative<CLit>(_sv.v())) {
        ...
        return cond_expr(CLit{clone_as_value<unsigned int>(d_a0)});
