...
struct LoopifyListCombining {
  ...
  append(const std::shared_ptr<List<unsigned int>> &a,
  ...
  static std::shared_ptr<List<unsigned int>>
  concat(const std::shared_ptr<List<std::shared_ptr<List<unsigned int>>>> &ll);
  static std::shared_ptr<List<unsigned int>>
  mapcat(const std::shared_ptr<List<unsigned int>> &l);
  static std::shared_ptr<List<unsigned int>>
  interleave_two(std::shared_ptr<List<unsigned int>> l1,
                 std::shared_ptr<List<unsigned int>> l2);
  static std::shared_ptr<List<unsigned int>> concat_sep(
