...
struct LoopifyListRelations {
  ...
  __attribute__((pure)) static bool is_suffix_of(const List<unsigned int> &l1,
                                                 const List<unsigned int> &l2);
  __attribute__((pure)) static bool
  is_infix_of_aux(const List<unsigned int> &needle,
                  const List<unsigned int> &haystack);
  __attribute__((pure)) static bool is_infix_of(const List<unsigned int> &_x0,
  ...
  __attribute__((pure)) static List<unsigned int>
  find_sublists(const List<unsigned int> &needle,
                const List<unsigned int> &haystack);
  __attribute__((pure)) static bool list_eq(const List<unsigned int> &l1,
                                            const List<unsigned int> &l2);
  __attribute__((pure)) static unsigned int
  list_compare(const List<unsigned int> &l1, const List<unsigned int> &l2);
  ...
  __attribute__((pure)) static List<unsigned int>
  union_(const List<unsigned int> &l1, List<unsigned int> l2);
  __attribute__((pure)) static List<unsigned int>
  intersection(const List<unsigned int> &l1, const List<unsigned int> &l2);
};
