...
struct LoopifyListSubsequences {
  ...
  static std::shared_ptr<List<std::shared_ptr<List<unsigned int>>>>
  inits_fuel(const unsigned int fuel,
  ...
  static std::shared_ptr<List<unsigned int>>
  snoc(const std::shared_ptr<List<unsigned int>> &l, const unsigned int x);
  __attribute__((pure)) static unsigned int
  last_elem(const std::shared_ptr<List<unsigned int>> &l);
  __attribute__((pure)) static unsigned int
  nth_elem(const unsigned int n, const std::shared_ptr<List<unsigned int>> &l);
