  ...
  while (!_stack.empty()) {
    ...
    if (std::holds_alternative<_Enter>(_frame)) {
      ...
      if (std::holds_alternative<
        ...
        const auto &_m =
            *std::get_if<typename LoopifyLists::list<unsigned int>::Cons>(
                &l->v());
  ...
  while (!_stack.empty()) {
    ...
    if (std::holds_alternative<_Enter>(_frame)) {
      ...
      if (std::holds_alternative<
        ...
        if (base <= _m.d_a0) {
          abs_val = (((_m.d_a0 - base) > _m.d_a0 ? 0 : (_m.d_a0 - base)));
        } else {
          abs_val = (((base - _m.d_a0) > base ? 0 : (base - _m.d_a0)));
        }
...
__attribute__((pure)) unsigned int LoopifyLists::four_elem(
  ...
  struct _Call1 {
    decltype((
        std::declval<typename LoopifyLists::list<unsigned int>::Cons &>().d_a0 +
        std::declval<typename LoopifyLists::list<unsigned int>::Cons &>()
            .d_a0)) _s0;
    decltype((
        std::declval<typename LoopifyLists::list<unsigned int>::Cons &>().d_a0 +
        std::declval<typename LoopifyLists::list<unsigned int>::Cons &>()
...
__attribute__((pure)) unsigned int LoopifyLists::max_prefix_sum(
  ...
  while (!_stack.empty()) {
    ...
    if (std::holds_alternative<_Enter>(_frame)) {
      ...
      const auto &_f = std::get<_Call1>(_frame);
      const typename LoopifyLists::list<unsigned int>::Cons _m = _f._s0;
      unsigned int rest = _result;
      unsigned int sum = (_m.d_a0 + rest);
      if (0u <= sum) {
        _result = sum;
      } else {
        _result = 0u;
    ...
    if (std::holds_alternative<typename LoopifyLists::list<unsigned int>::Nil>(
      ...
      if (std::holds_alternative<
        ...
        const auto &_m0 =
            *std::get_if<typename LoopifyLists::list<unsigned int>::Cons>(
                &_sv0->v());
        auto _cell = list<unsigned int>::cons((_m.d_a0 + _m0.d_a0), nullptr);
        if (_last) {
          std::get<typename list<unsigned int>::Cons>(_last->v_mut()).d_a1 =
              _cell;
        } else {
    ...
    if (std::holds_alternative<_Enter>(_frame)) {
      ...
      if (std::holds_alternative<
        ...
        const auto &_m =
            *std::get_if<typename LoopifyLists::list<unsigned int>::Cons>(
                &l->v());
        _stack.emplace_back(_Call1{(i * _m.d_a0)});
        _stack.emplace_back(_Enter{_m.d_a1, (i + 1)});
      }
    } else {
      const auto &_f = std::get<_Call1>(_frame);
      _result = (_f._s0 + _result);
...
std::shared_ptr<LoopifyLists::list<unsigned int>> LoopifyLists::prefix_sums(
  ...
  while (_continue) {
    if (std::holds_alternative<typename LoopifyLists::list<unsigned int>::Nil>(
      ...
      _last = _cell;
      std::shared_ptr<LoopifyLists::list<unsigned int>> _next_l = _m.d_a1;
      ...
      if (std::holds_alternative<
        ...
        const auto &_m0 =
            *std::get_if<typename LoopifyLists::list<unsigned int>::Cons>(
                &_loop_l2->v());
        if (_m.d_a0 == _m0.d_a0) {
          std::shared_ptr<LoopifyLists::list<unsigned int>> _next_l2 = _m0.d_a1;
          std::shared_ptr<LoopifyLists::list<unsigned int>> _next_l1 = _m.d_a1;
...
std::shared_ptr<LoopifyLists::list<unsigned int>> LoopifyLists::lookup_all(
  ...
  while (_continue) {
    if (std::holds_alternative<typename LoopifyLists::list<
      ...
      const auto &_m = *std::get_if<typename LoopifyLists::list<
...
__attribute__((pure)) unsigned int LoopifyLists::product(
  ...
  struct _Call1 {
    decltype(std::declval<typename LoopifyLists::list<unsigned int>::Cons &>()
                 .d_a0) _s0;
  };
...
__attribute__((pure)) unsigned int LoopifyLists::sum_list_lengths(
  ...
  struct _Call1 {
    decltype(len_list(
        std::declval<typename LoopifyLists::list<
            std::shared_ptr<LoopifyLists::list<unsigned int>>>::Cons &>()
            .d_a0)) _s0;
  };
  ...
  while (!_stack.empty()) {
    ...
    if (std::holds_alternative<_Enter>(_frame)) {
      ...
      if (std::holds_alternative<typename LoopifyLists::list<
        ...
        _stack.emplace_back(_Call1{len_list(_m.d_a0)});
        _stack.emplace_back(_Enter{_m.d_a1});
      }
    } else {
      const auto &_f = std::get<_Call1>(_frame);
  ...
  while (!_stack.empty()) {
    ...
    if (std::holds_alternative<_Enter>(_frame)) {
      ...
      const std::shared_ptr<LoopifyLists::list<unsigned int>> &evens =
          _result.second;
      _result = std::make_pair(list<unsigned int>::cons(_m.d_a0, evens), odds);
    }
  }
  return _result;
}
  ...
  while (_continue) {
    if (std::holds_alternative<typename LoopifyLists::list<unsigned int>::Nil>(
      ...
      if (std::holds_alternative<
        ...
        _rf.d_a1 = list<unsigned int>::cons(y, interleave(_m.d_a1, ys));
        if (_last) {
          std::get<typename list<unsigned int>::Cons>(_last->v_mut()).d_a1 =
              _loop_l2;
        } else {
        ...
        if (std::holds_alternative<
          ...
          if (_last) {
            std::get<typename list<
                ...
                .d_a1 =
                list<std::shared_ptr<LoopifyLists::list<unsigned int>>>::cons(
                    list<unsigned int>::cons(_m.d_a0,
                                             list<unsigned int>::nil()),
          ...
          const auto &_m0 =
              *std::get_if<typename LoopifyLists::list<unsigned int>::Cons>(
                  &_sv0->v());
          if (_m.d_a0 == _m0.d_a0) {
            auto &&_sv1 = group_fuel(f, _m.d_a1);
            if (std::holds_alternative<typename LoopifyLists::list<
                    std::shared_ptr<LoopifyLists::list<unsigned int>>>::Nil>(
                    _sv1->v())) {
              if (_last) {
              ...
              const auto &_m1 = *std::get_if<typename LoopifyLists::list<
                  std::shared_ptr<LoopifyLists::list<unsigned int>>>::Cons>(
                  &_sv1->v());
              if (_last) {
                std::get<typename list<
                    ...
                    .d_a1 =
                    list<std::shared_ptr<LoopifyLists::list<unsigned int>>>::
                        cons(list<unsigned int>::cons(_m.d_a0, _m1.d_a0),
                             _m1.d_a1);
              } else {
                _head =
                    list<std::shared_ptr<LoopifyLists::list<unsigned int>>>::
  ...
  while (_continue) {
    if (std::holds_alternative<typename LoopifyLists::list<unsigned int>::Nil>(
      ...
      std::shared_ptr<LoopifyLists::list<unsigned int>> _next_acc =
          list<unsigned int>::cons(_m.d_a0, _loop_acc);
      _loop_l = std::move(_next_l);
      _loop_acc = std::move(_next_acc);
    }
  }
    ...
    if (std::holds_alternative<_Enter>(_frame)) {
      ...
      if (std::holds_alternative<
        ...
        const auto &_m =
            *std::get_if<typename LoopifyLists::list<unsigned int>::Cons>(
                &l->v());
        _stack.emplace_back(_Call1{list<unsigned int>::nil(), _m.d_a0});
        _stack.emplace_back(_Enter{_m.d_a1});
      }
    } else {
      const auto &_f = std::get<_Call1>(_frame);
...
std::shared_ptr<LoopifyLists::list<unsigned int>> LoopifyLists::double_append(
  ...
  while (!_stack.empty()) {
    ...
    if (std::holds_alternative<_Enter>(_frame)) {
      ...
      _result = list<unsigned int>::cons(_m.d_a0, app_helper(rest, rest));
    }
  }
  return _result;
}
    ...
    if (std::holds_alternative<typename LoopifyLists::list<unsigned int>::Nil>(
      ...
      if (std::holds_alternative<
        ...
        const auto &_m0 =
            *std::get_if<typename LoopifyLists::list<unsigned int>::Cons>(
                &_sv0->v());
        if ((2u ? (_m.d_a0 + _m0.d_a0) % 2u : (_m.d_a0 + _m0.d_a0)) == 0u) {
          _loop_l = _m.d_a1;
          continue;
        } else {
          auto _cell = list<unsigned int>::cons(_m.d_a0, nullptr);
    ...
    if (std::holds_alternative<_Enter>(_frame)) {
      ...
      if (std::holds_alternative<
        ...
        if (n == 0u) {
          ...
          _stack.emplace_back(_Call1{_m});
          _stack.emplace_back(_Enter{_m.d_a1, (((n - 1u) > n ? 0 : (n - 1u)))});
        }
      }
    } else {
      const auto &_f = std::get<_Call1>(_frame);
      ...
      const std::shared_ptr<LoopifyLists::list<unsigned int>> &b =
          _result.second;
      _result = std::make_pair(list<unsigned int>::cons(_m.d_a0, a), b);
    }
  }
  return _result;
}
      ...
      if (_loop_n == 0u) {
        ...
        if (std::holds_alternative<
          ...
          std::shared_ptr<LoopifyLists::list<unsigned int>> _next_l =
              app_helper(_m.d_a1, list<unsigned int>::cons(
                                      _m.d_a0, list<unsigned int>::nil()));
          unsigned int _next_n =
              (((_loop_n - 1u) > _loop_n ? 0 : (_loop_n - 1u)));
          unsigned int _next_fuel = f;
...
std::shared_ptr<LoopifyLists::list<unsigned int>> LoopifyLists::intercalate(
  ...
  struct _Call1 {
    decltype(std::declval<typename LoopifyLists::list<
                 std::shared_ptr<LoopifyLists::list<unsigned int>>>::Cons &>()
                 .d_a0) _s0;
    ...
    if (std::holds_alternative<typename LoopifyLists::list<unsigned int>::Nil>(
      ...
      if (std::holds_alternative<
        ...
        if (std::holds_alternative<
          ...
          auto _cell = list<
              std::pair<std::pair<unsigned int, unsigned int>, unsigned int>>::
              cons(std::make_pair(std::make_pair(_m.d_a0, _m0.d_a0), _m1.d_a0),
                   nullptr);
          if (_last) {
            std::get<typename list<std::pair<
                std::pair<unsigned int, unsigned int>, unsigned int>>::Cons>(
          ...
          _last = _cell;
          std::shared_ptr<LoopifyLists::list<unsigned int>> _next_l3 = _m1.d_a1;
          std::shared_ptr<LoopifyLists::list<unsigned int>> _next_l2 = _m0.d_a1;
          std::shared_ptr<LoopifyLists::list<unsigned int>> _next_l1 = _m.d_a1;
