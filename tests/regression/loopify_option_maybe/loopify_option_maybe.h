...
struct LoopifyOptionMaybe {
  ...
  find_even(const List<unsigned int> &l);
  __attribute__((pure)) static std::optional<unsigned int>
  find_greater(const unsigned int &threshold, const List<unsigned int> &l);
  __attribute__((pure)) static std::optional<unsigned int>
  ...
  lookup_all(const unsigned int &key,
             const List<std::pair<unsigned int, unsigned int>> &l);
  __attribute__((pure)) static std::optional<unsigned int>
  safe_head(const List<unsigned int> &l);
  __attribute__((pure)) static std::optional<List<unsigned int>>
