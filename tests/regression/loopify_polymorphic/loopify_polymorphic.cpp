...
List<unsigned int> LoopifyPolymorphic::nat_take(unsigned int _x0,
                                                const List<unsigned int> &_x1) {
  return poly_take<unsigned int>(_x0, _x1);
}

List<unsigned int> LoopifyPolymorphic::nat_drop(unsigned int _x0,
                                                const List<unsigned int> &_x1) {
  return poly_drop<unsigned int>(_x0, _x1);
}

std::optional<unsigned int>
LoopifyPolymorphic::nat_nth(unsigned int _x0, const List<unsigned int> &_x1) {
  return poly_nth<unsigned int>(_x0, _x1);
}

bool LoopifyPolymorphic::nat_eq(unsigned int _x0, unsigned int _x1) {
  return _x0 == _x1;
}

bool LoopifyPolymorphic::is_even(unsigned int x) {
  return (2u ? x % 2u : x) == 0u;
}

bool LoopifyPolymorphic::nat_member(unsigned int _x0,
                                    const List<unsigned int> &_x1) {
  return poly_member<unsigned int>(nat_eq, _x0, _x1);
}

List<unsigned int> LoopifyPolymorphic::nat_replicate(unsigned int _x0,
                                                     unsigned int _x1) {
