...
LoopifySearch::longest_run(const std::shared_ptr<List<unsigned int>> &l) {
  return longest_run_aux(List<unsigned int>::ctor::Nil_(),
                         List<unsigned int>::ctor::Nil_(), l);
}
                    ...
                    Overloaded{
                        ...
                        [&](const typename List<unsigned int>::Cons _args)
                          ...
                          if (elem_impl(_args.d_a0, _args.d_a1)) {
                            _stack.push_back(_Enter{_args.d_a1, std::move(f)});
                          } else {
                            _stack.push_back(_Call1{_args.d_a0});
                            _stack.push_back(_Enter{_args.d_a1, std::move(f)});
                          }
    ...
    std::visit(
        Overloaded{
            ...
            [&](_Call1 _f) {
              ...
              _result = std::make_pair(
                  List<unsigned int>::ctor::Cons_(_args.d_a0, a),
                  List<unsigned int>::ctor::Cons_(_args0.d_a0, b));
            }},
        _frame);
  }
  return _result;
  ...
  struct _Call1 {
    decltype(map_cons(
        ...
        List<std::shared_ptr<List<unsigned int>>>::ctor::Cons_(
            List<unsigned int>::ctor::Nil_(),
            List<std::shared_ptr<List<unsigned int>>>::ctor::Nil_()))) _s0;
  };
...
LoopifySearch::all_indices_aux(const unsigned int x,
  ...
  std::shared_ptr<List<unsigned int>> _result{};
  std::vector<_Frame> _stack;
  _stack.push_back(_Enter{idx, l, x});
  while (!_stack.empty()) {
    _Frame _frame = std::move(_stack.back());
    _stack.pop_back();
    std::visit(
                         ...
                         Overloaded{
                             ...
                             [&](const typename List<unsigned int>::Cons _args)
                               ...
                               if (x == _args.d_a0) {
                                 ...
                                 _stack.push_back(_Enter{(std::move(idx) + 1),
                                                         _args.d_a1,
                                                         std::move(x)});
                               }
                             }},
