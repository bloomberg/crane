...
struct LoopifyTreeVariants {
  ...
  public:
      ...
      while (!_stack.empty()) {
        ...
        if (std::holds_alternative<_Enter>(_frame)) {
          ...
          if (std::holds_alternative<typename ternary::TLeaf>(_sv.v())) {
            ...
            _stack.emplace_back(_After1{d_a2.get(), d_a0.get(), 1u});
          ...
          _stack.emplace_back(_Combine3{_f._result, _result, _f._s2});
    ...
    unsigned int ternary_sum() const {
      ...
      /// Intermediate: saves [_s0, _s1, d_a1], dispatches next recursive call.
      struct _After1 {
        const ternary *_s0;
        const ternary *_s1;
        unsigned int d_a1;
      ...
      /// Intermediate: saves [_result, _s1, d_a1], dispatches next recursive
      /// call.
      struct _After2 {
        unsigned int _result;
        const ternary *_s1;
      ...
      while (!_stack.empty()) {
        ...
        if (std::holds_alternative<_Enter>(_frame)) {
          ...
          if (std::holds_alternative<typename ternary::TLeaf>(_sv.v())) {
            ...
            const auto &[d_a0, d_a1, d_a2, d_a3] =
                std::get<typename ternary::TNode>(_sv.v());
            _stack.emplace_back(_After1{d_a2.get(), d_a0.get(), d_a1});
            _stack.emplace_back(_Enter{d_a3.get()});
          }
        } else if (std::holds_alternative<_After1>(_frame)) {
          auto _f = std::move(std::get<_After1>(_frame));
          _stack.emplace_back(_After2{_result, _f._s1, _f.d_a1});
          _stack.emplace_back(_Enter{_f._s0});
        } else if (std::holds_alternative<_After2>(_frame)) {
          auto _f = std::move(std::get<_After2>(_frame));
          _stack.emplace_back(_Combine3{_f._result, _result, _f.d_a1});
          _stack.emplace_back(_Enter{_f._s1});
        } else {
          auto _f = std::move(std::get<_Combine3>(_frame));
    ...
    T1 ternary_rec(const T1 f, F1 &&f0) const {
      ...
      /// Intermediate: saves [_s0, _s1, _s2, _s3, d_a1, _s5], dispatches next
      /// recursive call.
      struct _After1 {
        const ternary *_s0;
        const ternary *_s1;
      ...
      /// Intermediate: saves [_result, _s1, _s2, _s3, d_a1, _s5], dispatches
      /// next recursive call.
      struct _After2 {
        T1 _result;
        const ternary *_s1;
      ...
      while (!_stack.empty()) {
        ...
        if (std::holds_alternative<_Enter>(_frame)) {
          ...
          if (std::holds_alternative<typename ternary::TLeaf>(_sv.v())) {
            ...
            const auto &[d_a0, d_a1, d_a2, d_a3] =
                std::get<typename ternary::TNode>(_sv.v());
            _stack.emplace_back(_After1{d_a2.get(), d_a0.get(), *(d_a3),
                                        *(d_a2), d_a1, *(d_a0)});
            _stack.emplace_back(_Enter{d_a3.get()});
          }
        } else if (std::holds_alternative<_After1>(_frame)) {
          auto _f = std::move(std::get<_After1>(_frame));
          _stack.emplace_back(_After2{_result, _f._s1, std::move(_f._s2),
                                      std::move(_f._s3), _f.d_a1,
                                      std::move(_f._s5)});
          _stack.emplace_back(_Enter{_f._s0});
        } else if (std::holds_alternative<_After2>(_frame)) {
          auto _f = std::move(std::get<_After2>(_frame));
          _stack.emplace_back(_Combine3{_f._result, _result, std::move(_f._s2),
                                        std::move(_f._s3), _f.d_a1,
                                        std::move(_f._s5)});
          _stack.emplace_back(_Enter{_f._s1});
        } else {
          auto _f = std::move(std::get<_Combine3>(_frame));
          _result = f0(_f._s5, _result, _f.d_a1, _f._s3, _f._result_1, _f._s2,
                       _f._result_0);
        }
      }
      return _result;
