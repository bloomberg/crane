...
struct LoopifyTrees {
  ...
  public:
    ...
    __attribute__((pure)) bool same_shape(const tree<T1> &t2) const {
      ...
      struct _Call1 {
        std::unique_ptr<tree<T1>> _s0;
        std::unique_ptr<tree<t_A>> _s1;
      };
      ...
      while (!_stack.empty()) {
        ...
        if (std::holds_alternative<_Enter>(_frame)) {
          ...
          auto _f = std::move(std::get<_Call1>(_frame));
          std::unique_ptr<tree<T1>> d_a20 = std::move(_f._s0);
          std::unique_ptr<tree<t_A>> d_a2 = std::move(_f._s1);
          if (_result) {
  ...
  public:
    ...
    __attribute__((pure)) static ternary tnode(const ternary &a0,
                                               ...
                                               const ternary &a2,
                                               unsigned int a3) {
      return ternary(TNode{std::make_unique<ternary>(a0.clone()),
                           std::make_unique<ternary>(a1.clone()),
  ...
  public:
    ...
    __attribute__((pure)) static rose rnode(unsigned int a0, List<rose> a1) {
      return rose(RNode{std::move(a0),
                        clone_as_value<List<std::unique_ptr<rose>>>(a1)});
    }
    ...
    // ACCESSORS
    __attribute__((pure)) rose *operator->() { return this; }

    __attribute__((pure)) const rose *operator->() const { return this; }
    ...
    template <typename T1,
              MapsTo<T1, unsigned int, List<std::unique_ptr<rose>>> F0>
  ...
  public:
    ...
    __attribute__((pure)) simple_tree clone() const {
      ...
      if (std::holds_alternative<SLeaf>(_sv.v())) {
        ...
        return simple_tree(
            SNode{clone_as_value<std::unique_ptr<simple_tree>>(d_a0),
                  clone_as_value<std::unique_ptr<simple_tree>>(d_a1)});
      }
    }
    ...
    __attribute__((pure)) static simple_tree snode(const simple_tree &a0,
      ...
      return simple_tree(SNode{std::make_unique<simple_tree>(a0.clone()),
                               std::make_unique<simple_tree>(a1.clone())});
    }
    ...
    // ACCESSORS
    __attribute__((pure)) simple_tree *operator->() { return this; }

    __attribute__((pure)) const simple_tree *operator->() const { return this; }
