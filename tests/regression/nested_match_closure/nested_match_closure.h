...
struct NestedMatchClosure {
  ...
  make_combiner(const std::shared_ptr<tree> &t);
  ...
  __attribute__((
      pure)) static std::optional<std::function<unsigned int(unsigned int)>>
  make_deep_combiner(const std::shared_ptr<tree> &t);
  ...
  __attribute__((
      pure)) static std::optional<std::function<unsigned int(unsigned int)>>
  make_param_combiner(const std::shared_ptr<tree> &t, const unsigned int base);
