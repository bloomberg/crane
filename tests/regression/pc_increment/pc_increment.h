...
struct PcIncrement {
  ...
  static inline const unsigned int test_inc1_wrap =
      pc_inc1(std::make_shared<state>(state{max_addr}));

  static inline const unsigned int test_inc2_wrap =
  ...
  static inline const std::pair<std::pair<unsigned int, unsigned int>,
                                unsigned int>
      t = std::make_pair(std::make_pair(test_inc1_wrap, test_inc2_wrap),
