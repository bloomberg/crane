...
struct Q {
  ...
  __attribute__((pure)) Q clone() const {
    return Q{clone_as_value<int64_t>((*(this)).Qnum),
             clone_as_value<unsigned int>((*(this)).Qden)};
  }
};
...
struct PolygonWindingAreaTraceCase {
  struct Point {
    ...
    __attribute__((pure)) Point clone() const {
      return Point{clone_as_value<Real>((*(this)).phi),
                   clone_as_value<Real>((*(this)).lambda)};
    }
  };
