  ...
  struct PulseCertificate {
    ...
    __attribute__((pure)) PulseCertificate clone() const {
      return PulseCertificate{
          clone_as_value<std::optional<unsigned int>>(
              (*(this)).certificate_first_active),
          clone_as_value<std::optional<unsigned int>>(
              (*(this)).certificate_last_active),
          clone_as_value<Runs>((*(this)).certificate_runs),
          clone_as_value<unsigned int>((*(this)).certificate_base),
          clone_as_value<List<PulseClass>>((*(this)).certificate_classes)};
    }
  };
