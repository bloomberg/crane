...
RamOps::upd_reg_in_chip_main(const RamOps::ram_chip_main &ch, unsigned int r,
...
RamOps::upd_chip_in_bank_main(const RamOps::ram_bank_main &bk, unsigned int c,
...
RamOps::upd_bank_in_sys_main(const RamOps::state_main &s, unsigned int b,
                             const RamOps::ram_bank_main &bk) {
  return update_nth_main<RamOps::ram_bank_main>(b, bk, s.ram_sys_main);
}

List<RamOps::ram_bank_main>
RamOps::ram_write_main_sys(const RamOps::state_main &s, unsigned int v) {
...
RamOps::upd_bank_in_sys_port(const RamOps::state_port &s, unsigned int b,
...
RamOps::get_chip_status(const RamOps::ram_bank_status &bk, unsigned int c) {
...
RamOps::upd_status_in_reg(const RamOps::ram_reg_status &rg, unsigned int i,
                          unsigned int v) {
...
RamOps::upd_bank_in_sys_status(const RamOps::state_status &s, unsigned int b,
                               const RamOps::ram_bank_status &bk) {
  return update_nth_status<RamOps::ram_bank_status>(b, bk, s.ram_sys_status);
}

List<RamOps::ram_bank_status>
RamOps::ram_write_status_sys(const RamOps::state_status &s, unsigned int idx,
                             unsigned int v) {
...
unsigned int RamOps::get_main_sel(const RamOps::ram_reg_sel &rg,
                                  unsigned int i) {
  return ListDef::template nth<unsigned int>(i, rg.reg_main_sel, 0u);
}

unsigned int RamOps::ram_read_main(const RamOps::state_sel &s) {
...
RamOps::get_chip_nested(const RamOps::ram_bank_nested &bk, unsigned int c) {
  return ListDef::template nth<RamOps::ram_chip_nested>(c, bk.bank_chips_nested,
                                                        empty_chip_nested);
}

RamOps::ram_reg_nested
RamOps::get_regRAM_nested(const RamOps::ram_chip_nested &ch, unsigned int r) {
  return ListDef::template nth<RamOps::ram_reg_nested>(r, ch.chip_regs_nested,
                                                       empty_reg_nested);
}

unsigned int RamOps::get_main_nested(const RamOps::ram_reg_nested &rg,
                                     unsigned int i) {
  return ListDef::template nth<unsigned int>(i, rg.reg_main_nested, 0u);
}

unsigned int RamOps::ram_read_main_nested(const RamOps::state_nested &s) {
...
RamOps::reg_frame RamOps::upd_main_in_reg_frame(const List<unsigned int> &rg,
                                                unsigned int i,
                                                unsigned int v) {
...
RamOps::upd_reg_in_chip_frame(const List<List<unsigned int>> &ch,
                              unsigned int r, const List<unsigned int> &rg) {
...
bool RamOps::ram_addr_disjointb(unsigned int b1, unsigned int c1,
...
RamOps::write_status0(const RamOps::state_nested_bank &s, unsigned int v) {
