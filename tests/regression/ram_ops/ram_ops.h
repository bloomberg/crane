      ...
      return std::visit(Overloaded{[](const typename List<T1>::Nil _args0)
                                   ...
                                   [&](const typename List<T1>::Cons _args0)
                                     ...
                                     return List<T1>::ctor::Cons_(
                                         _args0.d_a0, update_nth_main<T1>(
                                                          n_, x, _args0.d_a1));
                                   }},
                        l->v());
    }
    ...
    if (n <= 0) {
      ...
      return std::visit(Overloaded{[](const typename List<T1>::Nil _args0)
                                   ...
                                   [&](const typename List<T1>::Cons _args0)
                                       -> std::shared_ptr<List<T1>> {
                                     return List<T1>::ctor::Cons_(
                                         _args0.d_a0, update_nth_port<T1>(
                                                          n_, x, _args0.d_a1));
                                   }},
                        l->v());
    }
    ...
    if (n <= 0) {
      ...
      return std::visit(Overloaded{[](const typename List<T1>::Nil _args0)
                                   ...
                                   [&](const typename List<T1>::Cons _args0)
                                       -> std::shared_ptr<List<T1>> {
                                     return List<T1>::ctor::Cons_(
                                         _args0.d_a0, update_nth_status<T1>(
                                                          n_, x, _args0.d_a1));
                                   }},
                        l->v());
    }
    ...
    if (n <= 0) {
      ...
      return std::visit(Overloaded{[](const typename List<T1>::Nil _args0)
                                   ...
                                   [&](const typename List<T1>::Cons _args0)
                                       -> std::shared_ptr<List<T1>> {
                                     return List<T1>::ctor::Cons_(
                                         _args0.d_a0, update_nth_frame<T1>(
                                                          n_, x, _args0.d_a1));
                                   }},
                        l->v());
    }
    ...
    if (n <= 0) {
      ...
      return std::visit(Overloaded{[](const typename List<T1>::Nil _args0)
                                   ...
                                   [&](const typename List<T1>::Cons _args0)
                                       -> std::shared_ptr<List<T1>> {
                                     return List<T1>::ctor::Cons_(
                                         _args0.d_a0, update_nth_preserve<T1>(
                                                          n_, x, _args0.d_a1));
                                   }},
                        l->v());
    }
      ...
      return std::visit(
          Overloaded{[](const typename List<T1>::Nil _args0)
                     ...
                     [&](const typename List<T1>::Cons _args0)
                       ...
                       return List<T1>::ctor::Cons_(
                           _args0.d_a0,
                           update_nth_nested_bank<T1>(n_, x, _args0.d_a1));
                     }},
          l->v());
    }
  }
