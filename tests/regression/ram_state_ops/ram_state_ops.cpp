...
RamStateOps::ram_reg
RamStateOps::upd_main_in_reg(const RamStateOps::ram_reg &rg, unsigned int i,
                             unsigned int v) {
...
RamStateOps::ram_reg
RamStateOps::upd_stat_in_reg(const RamStateOps::ram_reg &rg, unsigned int i,
                             unsigned int v) {
...
RamStateOps::upd_reg_in_chip(const RamStateOps::ram_chip &ch, unsigned int r,
...
RamStateOps::ram_chip
RamStateOps::upd_port_in_chip(const RamStateOps::ram_chip &ch, unsigned int v) {
...
RamStateOps::upd_chip_in_bank(const RamStateOps::ram_bank &bk, unsigned int c,
...
RamStateOps::upd_bank_in_sys(const RamStateOps::state &s, unsigned int b,
...
List<RamStateOps::ram_bank>
RamStateOps::ram_write_main_sys(const RamStateOps::state &s, unsigned int v) {
...
List<RamStateOps::ram_bank>
RamStateOps::ram_write_status_sys(const RamStateOps::state &s, unsigned int idx,
                                  unsigned int v) {
  RamStateOps::ram_reg rg = current_reg(s);
  RamStateOps::ram_chip ch = current_chip(s);
  RamStateOps::ram_bank bk = current_bank(s);
...
RamStateOps::pop_stack(RamStateOps::state s) {
  ...
  if (std::holds_alternative<typename List<unsigned int>::Nil>(_sv.v())) {
    ...
    return std::make_pair(std::make_optional<unsigned int>(a0),
