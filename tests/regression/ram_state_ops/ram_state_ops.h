...
struct RamStateOps {
  ...
  static inline const state bad_state_pc_overflow =
      state(ListDef::template repeat<unsigned int>(0u, 16u), 0u, false, 4096u,
            List<unsigned int>::nil(), empty_ram, default_sel,
            ListDef::template repeat<unsigned int>(0u, 8u));
  static inline const state bad_state_stack_overflow = state(
      ...
      empty_ram, default_sel, ListDef::template repeat<unsigned int>(0u, 8u));
  ...
  static inline const state stack_state = state(
      ...
      empty_ram, default_sel, ListDef::template repeat<unsigned int>(0u, 8u));
  static inline const state cleared_state = state(
      ListDef::template repeat<unsigned int>(0u, 16u), 7u, true, 99u,
      List<unsigned int>::cons(300u, List<unsigned int>::nil()), empty_ram,
      ram_sel(3u, 2u, 1u, 7u), ListDef::template repeat<unsigned int>(0u, 8u));
