...
struct RegisterPair {
  ...
  static inline const bool even_projection = (pair_base(6u) == 6u);

  static inline const bool odd_projection = (pair_base(7u) == 6u);

  static inline const bool set_pair_get_high =
      (get_reg(set_reg_pair(sample, 2u, 171u), 2u) == 10u);

  static inline const bool set_pair_get_low =
      (get_reg(set_reg_pair(sample, 2u, 171u), 3u) == 11u);
};
