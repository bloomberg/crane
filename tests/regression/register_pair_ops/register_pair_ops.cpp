...
RegisterPairOps::set_reg_pair(const RegisterPairOps::state &s, unsigned int r,
                              unsigned int v) {
  unsigned int base =
      (((r - (2u ? r % 2u : r)) > r ? 0 : (r - (2u ? r % 2u : r))));
...
unsigned int RegisterPairOps::pair_base(unsigned int r) {
  return (((r - (2u ? r % 2u : r)) > r ? 0 : (r - (2u ? r % 2u : r))));
}

unsigned int RegisterPairOps::pair_index(unsigned int r) {
  return (2u ? r / 2u : 0);
}

bool RegisterPairOps::pair_property(unsigned int r) {
