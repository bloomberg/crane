#ifndef INCLUDED_SIGT_ERASED_STRUCTURED_BINDING
#define INCLUDED_SIGT_ERASED_STRUCTURED_BINDING
...
struct SigtErasedStructuredBinding {
...
#endif // INCLUDED_SIGT_ERASED_STRUCTURED_BINDING
