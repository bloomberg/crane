...
Module ValidProgramOddReject.

Definition valid_program (bytes : list nat) : bool :=
  (length bytes mod 2 =? 0) && forallb (fun b => b <? 256) bytes.

Definition t : bool := valid_program [1; 2; 3].

End ValidProgramOddReject.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "valid_program_odd_reject" ValidProgramOddReject.
