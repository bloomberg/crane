...
struct ValidatedVirtualCrossmatchTraceCase {
  ...
  static inline const std::shared_ptr<MFIThresholdConfig>
      example_luminex_thresholds =
          std::make_shared<MFIThresholdConfig>(MFIThresholdConfig{
              1000u, 3000u,
              Nat::of_num_uint(
                  Uint1::ctor::UIntDecimal_(Uint::ctor::D8_(Uint::ctor::D0_(
                      Uint::ctor::D0_(Uint::ctor::D0_(Uint::ctor::Nil_())))))),
              Nat::of_num_uint(Uint1::ctor::UIntDecimal_(
                  Uint::ctor::D1_(Uint::ctor::D2_(Uint::ctor::D0_(
                      Uint::ctor::D0_(Uint::ctor::D0_(Uint::ctor::Nil_()))))))),
              1u, true});
  ...
  static inline const std::shared_ptr<HLATyping> donor_hla = std::make_shared<
      HLATyping>(HLATyping{List<std::shared_ptr<HLAAllele>>::ctor::Cons_(
      std::make_shared<HLAAllele>(HLAAllele{HLALocus::e_LOCUS_A, 2u}),
      List<std::shared_ptr<HLAAllele>>::ctor::Cons_(
      ...
      std::make_shared<VirtualXMProfile>(VirtualXMProfile{
          List<std::shared_ptr<EpitopeAntibody>>::ctor::Cons_(
              std::make_shared<EpitopeAntibody>(EpitopeAntibody{
                  eplet_65QIA,
                  Nat::of_num_uint(Uint1::ctor::UIntDecimal_(
                      Uint::ctor::D9_(Uint::ctor::D0_(Uint::ctor::D0_(
                          Uint::ctor::D0_(Uint::ctor::Nil_())))))),
                  true}),
              List<std::shared_ptr<EpitopeAntibody>>::ctor::Cons_(
                  std::make_shared<EpitopeAntibody>(EpitopeAntibody{
                      eplet_142T,
                      Nat::of_num_uint(Uint1::ctor::UIntDecimal_(
                          Uint::ctor::D6_(Uint::ctor::D0_(Uint::ctor::D0_(
                              Uint::ctor::D0_(Uint::ctor::Nil_())))))),
                      false}),
                  List<std::shared_ptr<EpitopeAntibody>>::ctor::Nil_())),
          95u, 98u, 5u});
