...
(* Behavioral candidate: a state with program-counter overflow is not WF. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module BadStatePcOverflowNotWfProp.
...
Definition t : Prop :=
  ~ WF bad_state_pc_overflow.

End BadStatePcOverflowNotWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "bad_state_pc_overflow_not_wf_prop" BadStatePcOverflowNotWfProp.
