...
(* Behavioral candidate: a state with stack overflow is not WF. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module BadStateStackOverflowNotWfProp.
...
Definition t : Prop :=
  ~ WF bad_state_stack_overflow.

End BadStateStackOverflowNotWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "bad_state_stack_overflow_not_wf_prop" BadStateStackOverflowNotWfProp.
