...
(* Behavioral candidate: a state with the wrong register-file length is not WF. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module BadStateWrongRegCountNotWfProp.
...
Definition t : Prop :=
  ~ WF bad_state_wrong_reg_count.

End BadStateWrongRegCountNotWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "bad_state_wrong_reg_count_not_wf_prop" BadStateWrongRegCountNotWfProp.
