...
unsigned int
CpuExecuteWf::get_reg(const std::shared_ptr<CpuExecuteWf::state> &s,
                      const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
CpuExecuteWf::set_reg(const std::shared_ptr<CpuExecuteWf::state> &s,
                      const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int CpuExecuteWf::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
CpuExecuteWf::get_pair(const std::shared_ptr<CpuExecuteWf::state> &s,
                       const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
CpuExecuteWf::set_pair(const std::shared_ptr<CpuExecuteWf::state> &s,
                       const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
CpuExecuteWf::push_return(std::shared_ptr<CpuExecuteWf::state> s,
...
std::shared_ptr<CpuExecuteWf::state>
CpuExecuteWf::execute(std::shared_ptr<CpuExecuteWf::state> s,
                      const std::shared_ptr<CpuExecuteWf::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename CpuExecuteWf::instr::NOP _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            return std::make_shared<CpuExecuteWf::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename CpuExecuteWf::instr::LDM _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            unsigned int n = _args._a0;
            return std::make_shared<CpuExecuteWf::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename CpuExecuteWf::instr::LD _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
          ...
          [&](const typename CpuExecuteWf::instr::XCH _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename CpuExecuteWf::instr::INC _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            unsigned int r = _args._a0;
            return std::make_shared<CpuExecuteWf::state>(
          ...
          [&](const typename CpuExecuteWf::instr::ADD _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename CpuExecuteWf::instr::SUB _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename CpuExecuteWf::instr::IAC _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            return std::make_shared<CpuExecuteWf::state>(
          ...
          [&](const typename CpuExecuteWf::instr::DAC _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            return std::make_shared<CpuExecuteWf::state>(
          ...
          [&](const typename CpuExecuteWf::instr::CLC _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            return std::make_shared<CpuExecuteWf::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename CpuExecuteWf::instr::STC _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            return std::make_shared<CpuExecuteWf::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename CpuExecuteWf::instr::CMC _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            return std::make_shared<CpuExecuteWf::state>(
          ...
          [&](const typename CpuExecuteWf::instr::CMA _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            return std::make_shared<CpuExecuteWf::state>(
          ...
          [&](const typename CpuExecuteWf::instr::CLB _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            return std::make_shared<CpuExecuteWf::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename CpuExecuteWf::instr::RAL _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
          ...
          [&](const typename CpuExecuteWf::instr::RAR _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
          ...
          [&](const typename CpuExecuteWf::instr::TCC _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            return std::make_shared<CpuExecuteWf::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename CpuExecuteWf::instr::TCS _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            return std::make_shared<CpuExecuteWf::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename CpuExecuteWf::instr::DAA _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename CpuExecuteWf::instr::KBP _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
          ...
          [&](const typename CpuExecuteWf::instr::JUN _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
          ...
          [&](const typename CpuExecuteWf::instr::JMS _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            unsigned int a = _args._a0;
            return std::make_shared<CpuExecuteWf::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename CpuExecuteWf::instr::JCN _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
          ...
          [&](const typename CpuExecuteWf::instr::FIM _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename CpuExecuteWf::instr::SRC _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            unsigned int r = _args._a0;
            return std::make_shared<CpuExecuteWf::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename CpuExecuteWf::instr::FIN _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            unsigned int r = _args._a0;
            return std::make_shared<CpuExecuteWf::state>(
          ...
          [&](const typename CpuExecuteWf::instr::JIN _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            unsigned int r = _args._a0;
            return std::make_shared<CpuExecuteWf::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename CpuExecuteWf::instr::ISZ _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename CpuExecuteWf::instr::BBL _args)
              -> std::shared_ptr<CpuExecuteWf::state> {
