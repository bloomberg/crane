...
unsigned int CpuPcShape::get_reg(const std::shared_ptr<CpuPcShape::state> &s,
                                 const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
CpuPcShape::set_reg(const std::shared_ptr<CpuPcShape::state> &s,
                    const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int CpuPcShape::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int CpuPcShape::get_pair(const std::shared_ptr<CpuPcShape::state> &s,
                                  const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
CpuPcShape::set_pair(const std::shared_ptr<CpuPcShape::state> &s,
                     const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
CpuPcShape::push_return(std::shared_ptr<CpuPcShape::state> s,
...
std::shared_ptr<CpuPcShape::state>
CpuPcShape::execute(std::shared_ptr<CpuPcShape::state> s,
                    const std::shared_ptr<CpuPcShape::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename CpuPcShape::instr::NOP _args)
              -> std::shared_ptr<CpuPcShape::state> {
            return std::make_shared<CpuPcShape::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename CpuPcShape::instr::LDM _args)
              -> std::shared_ptr<CpuPcShape::state> {
            unsigned int n = _args._a0;
            return std::make_shared<CpuPcShape::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename CpuPcShape::instr::LD _args)
              -> std::shared_ptr<CpuPcShape::state> {
          ...
          [&](const typename CpuPcShape::instr::XCH _args)
              -> std::shared_ptr<CpuPcShape::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename CpuPcShape::instr::INC _args)
              -> std::shared_ptr<CpuPcShape::state> {
            unsigned int r = _args._a0;
            return std::make_shared<CpuPcShape::state>(
          ...
          [&](const typename CpuPcShape::instr::ADD _args)
              -> std::shared_ptr<CpuPcShape::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename CpuPcShape::instr::SUB _args)
              -> std::shared_ptr<CpuPcShape::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename CpuPcShape::instr::IAC _args)
              -> std::shared_ptr<CpuPcShape::state> {
            return std::make_shared<CpuPcShape::state>(
          ...
          [&](const typename CpuPcShape::instr::DAC _args)
              -> std::shared_ptr<CpuPcShape::state> {
            return std::make_shared<CpuPcShape::state>(
          ...
          [&](const typename CpuPcShape::instr::CLC _args)
              -> std::shared_ptr<CpuPcShape::state> {
            return std::make_shared<CpuPcShape::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename CpuPcShape::instr::STC _args)
              -> std::shared_ptr<CpuPcShape::state> {
            return std::make_shared<CpuPcShape::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename CpuPcShape::instr::CMC _args)
              -> std::shared_ptr<CpuPcShape::state> {
            return std::make_shared<CpuPcShape::state>(
          ...
          [&](const typename CpuPcShape::instr::CMA _args)
              -> std::shared_ptr<CpuPcShape::state> {
            return std::make_shared<CpuPcShape::state>(
          ...
          [&](const typename CpuPcShape::instr::CLB _args)
              -> std::shared_ptr<CpuPcShape::state> {
            return std::make_shared<CpuPcShape::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename CpuPcShape::instr::RAL _args)
              -> std::shared_ptr<CpuPcShape::state> {
          ...
          [&](const typename CpuPcShape::instr::RAR _args)
              -> std::shared_ptr<CpuPcShape::state> {
          ...
          [&](const typename CpuPcShape::instr::TCC _args)
              -> std::shared_ptr<CpuPcShape::state> {
            return std::make_shared<CpuPcShape::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename CpuPcShape::instr::TCS _args)
              -> std::shared_ptr<CpuPcShape::state> {
            return std::make_shared<CpuPcShape::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename CpuPcShape::instr::DAA _args)
              -> std::shared_ptr<CpuPcShape::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename CpuPcShape::instr::KBP _args)
              -> std::shared_ptr<CpuPcShape::state> {
          ...
          [&](const typename CpuPcShape::instr::JUN _args)
              -> std::shared_ptr<CpuPcShape::state> {
          ...
          [&](const typename CpuPcShape::instr::JMS _args)
              -> std::shared_ptr<CpuPcShape::state> {
            unsigned int a = _args._a0;
            return std::make_shared<CpuPcShape::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename CpuPcShape::instr::JCN _args)
              -> std::shared_ptr<CpuPcShape::state> {
          ...
          [&](const typename CpuPcShape::instr::FIM _args)
              -> std::shared_ptr<CpuPcShape::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename CpuPcShape::instr::SRC _args)
              -> std::shared_ptr<CpuPcShape::state> {
            unsigned int r = _args._a0;
            return std::make_shared<CpuPcShape::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename CpuPcShape::instr::FIN _args)
              -> std::shared_ptr<CpuPcShape::state> {
            unsigned int r = _args._a0;
            return std::make_shared<CpuPcShape::state>(
          ...
          [&](const typename CpuPcShape::instr::JIN _args)
              -> std::shared_ptr<CpuPcShape::state> {
            unsigned int r = _args._a0;
            return std::make_shared<CpuPcShape::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename CpuPcShape::instr::ISZ _args)
              -> std::shared_ptr<CpuPcShape::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename CpuPcShape::instr::BBL _args)
              -> std::shared_ptr<CpuPcShape::state> {
