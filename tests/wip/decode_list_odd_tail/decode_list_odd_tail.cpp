...
#include <any>
#include <cassert>
#include <decode_list_odd_tail.h>
#include <functional>
#include <iostream>
#include <memory>
#include <optional>
...
std::shared_ptr<DecodeListOddTail::instruction>
DecodeListOddTail::decode(const unsigned int b1, const unsigned int b2) {
  if ((b1 == 0)) {
...
std::shared_ptr<List<std::shared_ptr<DecodeListOddTail::instruction>>>
DecodeListOddTail::decode_list(
    const std::shared_ptr<List<unsigned int>> &bytes) {
  return std::visit(
      Overloaded{
          [](const typename List<unsigned int>::nil _args)
              -> std::shared_ptr<
                  List<std::shared_ptr<DecodeListOddTail::instruction>>> {
            return List<
                std::shared_ptr<DecodeListOddTail::instruction>>::ctor::nil_();
          },
                    ...
                    Overloaded{
                        [](const typename List<unsigned int>::nil _args)
                            -> std::shared_ptr<List<std::shared_ptr<
                                DecodeListOddTail::instruction>>> {
                          return List<std::shared_ptr<
                              DecodeListOddTail::instruction>>::ctor::nil_();
                        },
                        [&](const typename List<unsigned int>::cons _args)
                            -> std::shared_ptr<List<std::shared_ptr<
                                DecodeListOddTail::instruction>>> {
