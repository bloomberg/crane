...
#include <any>
#include <cassert>
#include <decode_opcode_0_wf_edge_0043.h>
#include <functional>
#include <iostream>
#include <memory>
#include <optional>
...
std::shared_ptr<DecodeOpcode0WfEdge0043::instruction>
DecodeOpcode0WfEdge0043::decode(const unsigned int b1, const unsigned int b2) {
  if ((b1 == 0u)) {
...
std::optional<std::pair<std::shared_ptr<DecodeOpcode0WfEdge0043::instruction>,
                        unsigned int>>
DecodeOpcode0WfEdge0043::disassemble(
                    ...
                    [](const typename List<unsigned int>::nil _args)
                        -> std::optional<
                            std::pair<std::shared_ptr<
                                          DecodeOpcode0WfEdge0043::instruction>,
                                      unsigned int>> { return std::nullopt; },
                    [&](const typename List<unsigned int>::cons _args)
                        -> std::optional<
                            std::pair<std::shared_ptr<
