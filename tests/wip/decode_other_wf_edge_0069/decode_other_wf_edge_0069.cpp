...
#include <any>
#include <cassert>
#include <decode_other_wf_edge_0069.h>
#include <functional>
#include <iostream>
#include <memory>
#include <optional>
...
std::shared_ptr<DecodeOtherWfEdge0069::instruction>
DecodeOtherWfEdge0069::decode(const unsigned int b1, const unsigned int b2) {
  if ((b1 == 0)) {
...
std::shared_ptr<List<std::shared_ptr<DecodeOtherWfEdge0069::instruction>>>
DecodeOtherWfEdge0069::decode_list(
    const std::shared_ptr<List<unsigned int>> &bytes) {
  return std::visit(
      Overloaded{
          [](const typename List<unsigned int>::nil _args)
              -> std::shared_ptr<
                  List<std::shared_ptr<DecodeOtherWfEdge0069::instruction>>> {
            return List<std::shared_ptr<DecodeOtherWfEdge0069::instruction>>::
                ctor::nil_();
          },
                    ...
                    Overloaded{
                        [](const typename List<unsigned int>::nil _args)
                            -> std::shared_ptr<List<std::shared_ptr<
                                DecodeOtherWfEdge0069::instruction>>> {
                          return List<std::shared_ptr<
                              DecodeOtherWfEdge0069::instruction>>::ctor::
                              nil_();
                        },
                        [&](const typename List<unsigned int>::cons _args)
                            -> std::shared_ptr<List<std::shared_ptr<
