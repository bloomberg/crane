...
#include <any>
#include <cassert>
#include <decode_wf_opcode_5_edge_0075.h>
#include <functional>
#include <iostream>
#include <memory>
#include <optional>
...
std::shared_ptr<DecodeWfOpcode5Edge0075::instruction>
DecodeWfOpcode5Edge0075::decode(const unsigned int b1, const unsigned int b2) {
  if ((b1 == 0)) {
...
std::optional<std::pair<std::shared_ptr<DecodeWfOpcode5Edge0075::instruction>,
                        unsigned int>>
DecodeWfOpcode5Edge0075::disassemble(
                    ...
                    [](const typename List<unsigned int>::nil _args)
                        -> std::optional<
                            std::pair<std::shared_ptr<
                                          DecodeWfOpcode5Edge0075::instruction>,
                                      unsigned int>> { return std::nullopt; },
                    [&](const typename List<unsigned int>::cons _args)
                        -> std::optional<
                            std::pair<std::shared_ptr<
