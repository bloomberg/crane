#ifndef INCLUDED_ERASED_INSTANCE_ARGUMENT_IN_MENTION
#define INCLUDED_ERASED_INSTANCE_ARGUMENT_IN_MENTION
...
#endif // INCLUDED_ERASED_INSTANCE_ARGUMENT_IN_MENTION
