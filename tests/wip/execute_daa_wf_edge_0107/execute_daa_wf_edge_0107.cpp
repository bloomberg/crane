...
#include <any>
#include <cassert>
#include <execute_daa_wf_edge_0107.h>
#include <functional>
#include <iostream>
#include <memory>
#include <optional>
...
std::shared_ptr<ExecuteDaaWfEdge0107::instruction>
ExecuteDaaWfEdge0107::decode(const unsigned int b1, const unsigned int b2) {
  if ((b1 == 0u)) {
...
std::optional<
    std::pair<std::shared_ptr<ExecuteDaaWfEdge0107::instruction>, unsigned int>>
ExecuteDaaWfEdge0107::disassemble(
    const std::shared_ptr<List<unsigned int>> &rom, const unsigned int addr) {
  return std::visit(
      Overloaded{
          [](const typename List<unsigned int>::nil _args)
              -> std::optional<
                  std::pair<std::shared_ptr<ExecuteDaaWfEdge0107::instruction>,
