...
#include <any>
#include <cassert>
#include <execute_tcc_wf_edge_0105.h>
#include <functional>
#include <iostream>
#include <memory>
#include <optional>
...
std::shared_ptr<List<std::shared_ptr<ExecuteTccWfEdge0105::instruction>>>
ExecuteTccWfEdge0105::decode_list(
    const std::shared_ptr<List<unsigned int>> &bytes) {
  return std::visit(
      Overloaded{
          [](const typename List<unsigned int>::nil _args)
              -> std::shared_ptr<
                  List<std::shared_ptr<ExecuteTccWfEdge0105::instruction>>> {
            return List<std::shared_ptr<ExecuteTccWfEdge0105::instruction>>::
                ctor::nil_();
          },
                    ...
                    Overloaded{
                        [](const typename List<unsigned int>::nil _args)
                            -> std::shared_ptr<List<std::shared_ptr<
                                ExecuteTccWfEdge0105::instruction>>> {
                          return List<std::shared_ptr<
                              ExecuteTccWfEdge0105::instruction>>::ctor::nil_();
                        },
                        [&](const typename List<unsigned int>::cons _args)
                            -> std::shared_ptr<List<std::shared_ptr<
                                ExecuteTccWfEdge0105::instruction>>> {
                          ...
                          return List<std::shared_ptr<
                              ExecuteTccWfEdge0105::instruction>>::ctor::
