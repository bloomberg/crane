...
struct FoldClosureBuild {
  ...
  static T1 fold_left(F0 &&f, const T1 acc,
                      const std::shared_ptr<mylist<T2>> &l) {
  ...
  compose_adders(const std::shared_ptr<mylist<unsigned int>> &l,
  ...
  collect_adders(const std::shared_ptr<mylist<unsigned int>> &l);
  __attribute__((pure)) static unsigned int apply_all(
  ...
  __attribute__((pure)) static unsigned int
  compose_with_fix(const std::shared_ptr<mylist<unsigned int>> &l,
                   const unsigned int _x0);
