#ifndef INCLUDED_FOLDED_INDUCTIVE_NOT_CAPITALIZED
#define INCLUDED_FOLDED_INDUCTIVE_NOT_CAPITALIZED
...
#endif // INCLUDED_FOLDED_INDUCTIVE_NOT_CAPITALIZED
