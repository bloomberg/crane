...
struct GeneratedMethodNameClash {
  ...
  public:
    ...
    // CREATORS
    static token clone() { return token(Clone{}); }

    static token v() { return token(V{}); }
  ...
  template <typename T1, MapsTo<T1, bool> F2>
  ...
  static inline const bool sample = is_clone(token::clone());
};
