...
(* Behavioral candidate: get_bank_from_sys returns the freshly written bank after upd_bank_in_sys. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module GetBankUpdBankInSysProp.
...
Definition t : Prop :=
  get_bank_from_sys patched_system 3 = patched_bank.

End GetBankUpdBankInSysProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "get_bank_upd_bank_in_sys_prop" GetBankUpdBankInSysProp.
