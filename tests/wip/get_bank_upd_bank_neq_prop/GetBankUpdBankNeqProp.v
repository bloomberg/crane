...
(* Behavioral candidate: upd_bank_in_sys preserves other banks. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module GetBankUpdBankNeqProp.
...
Definition t : Prop :=
  get_bank_from_sys patched_system 0 = get_bank_from_sys (state_ram init_state) 0.

End GetBankUpdBankNeqProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "get_bank_upd_bank_neq_prop" GetBankUpdBankNeqProp.
