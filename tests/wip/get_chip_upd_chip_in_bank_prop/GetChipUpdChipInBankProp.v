...
(* Behavioral candidate: get_chip returns the freshly written chip after upd_chip_in_bank. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module GetChipUpdChipInBankProp.
...
Definition t : Prop :=
  chip_port (get_chip (upd_chip_in_bank empty_bank 2 (upd_port_in_chip empty_chip 9)) 2) = 9.

End GetChipUpdChipInBankProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "get_chip_upd_chip_in_bank_prop" GetChipUpdChipInBankProp.
