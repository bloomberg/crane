...
(* Behavioral candidate: upd_chip_in_bank preserves other chips. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module GetChipUpdChipNeqProp.
...
Definition t : Prop :=
  chip_port (get_chip patched_bank 0) = chip_port empty_chip.

End GetChipUpdChipNeqProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "get_chip_upd_chip_neq_prop" GetChipUpdChipNeqProp.
