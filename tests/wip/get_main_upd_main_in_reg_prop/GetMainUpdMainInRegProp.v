...
(* Behavioral candidate: get_main returns the freshly written value after upd_main_in_reg. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module GetMainUpdMainInRegProp.
...
Definition t : Prop :=
  get_main (upd_main_in_reg empty_reg 2 9) 2 = 9.

End GetMainUpdMainInRegProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "get_main_upd_main_in_reg_prop" GetMainUpdMainInRegProp.
