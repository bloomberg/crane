...
(* Behavioral candidate: upd_main_in_reg preserves other main characters. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module GetMainUpdMainNeqProp.
...
Definition t : Prop :=
  get_main (upd_main_in_reg empty_reg 2 9) 1 = get_main empty_reg 1.

End GetMainUpdMainNeqProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "get_main_upd_main_neq_prop" GetMainUpdMainNeqProp.
