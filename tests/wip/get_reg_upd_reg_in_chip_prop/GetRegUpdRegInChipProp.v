...
(* Behavioral candidate: get_regRAM returns the freshly written register after upd_reg_in_chip. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module GetRegUpdRegInChipProp.
...
Definition t : Prop :=
  get_main (get_regRAM (upd_reg_in_chip empty_chip 1 patched_reg) 1) 0 = 13.

End GetRegUpdRegInChipProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "get_reg_upd_reg_in_chip_prop" GetRegUpdRegInChipProp.
