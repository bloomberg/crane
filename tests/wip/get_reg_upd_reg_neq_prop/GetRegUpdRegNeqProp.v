...
(* Behavioral candidate: upd_reg_in_chip preserves other registers. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module GetRegUpdRegNeqProp.
...
Definition t : Prop :=
  get_main (get_regRAM patched_chip 0) 0 = get_main empty_reg 0.

End GetRegUpdRegNeqProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "get_reg_upd_reg_neq_prop" GetRegUpdRegNeqProp.
