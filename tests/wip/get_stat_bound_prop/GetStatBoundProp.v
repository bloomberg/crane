...
(* Behavioral candidate: get_stat returns a nibble-bounded status character. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module GetStatBoundProp.
...
Definition t : Prop :=
  get_stat empty_reg 2 < 16.

End GetStatBoundProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "get_stat_bound_prop" GetStatBoundProp.
