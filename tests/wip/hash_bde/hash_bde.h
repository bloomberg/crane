...
struct CHT {
    ...
    bsl::optional<T2> assoc_lookup(
           F0&&                                                            eqb,
           const T1                                                        k,
           const bsl::shared_ptr<typename List::list<bsl::pair<T1, T2> > > xs)
    {
        return bsl::visit(
              bdlf::Overloaded{
                  [&](const typename List::nil<bsl::pair<T1, T2> > _args)
                      -> bsl::optional<T2> {
                      return bsl::nullopt;
                  },
                  [&](const typename List::cons<bsl::pair<T1, T2> > _args)
                      -> bsl::optional<T2> {
    ...
    struct CHT {
        ...
        bsl::vector<bsl::shared_ptr<stm::TVar<
            bsl::shared_ptr<typename List::list<bsl::pair<K, V> > > > > >
                                  cht_buckets;
        int                       cht_nbuckets;
    ...
    template <typename T1, typename T2>
    bsl::shared_ptr<
        stm::TVar<bsl::shared_ptr<typename List::list<bsl::pair<T1, T2> > > > >
    ...
    template <typename T1, typename T2>
    bsl::optional<T2> stm_get(const bsl::shared_ptr<CHT<T1, T2> > t,
                              const T1                            k)
    {
        bsl::shared_ptr<stm::TVar<
            bsl::shared_ptr<typename List::list<bsl::pair<T1, T2> > > > >
            b = bucket_of<T1, T2>(t, k);
        bsl::shared_ptr<typename List::list<bsl::pair<T1, T2> > > xs =
            stm::readTVar<
                bsl::shared_ptr<typename List::list<bsl::pair<T1, T2> > > >(b);
    ...
    void stm_put(const bsl::shared_ptr<CHT<T1, T2> > t, const T1 k, const T2 v)
    {
        ...
        bsl::shared_ptr<typename List::list<bsl::pair<T1, T2> > > xs =
            stm::readTVar<
                bsl::shared_ptr<typename List::list<bsl::pair<T1, T2> > > >(b);
        bsl::shared_ptr<typename List::list<bsl::pair<T1, T2> > > xs_ =
    ...
    template <typename T1, typename T2>
    bsl::optional<T2> stm_delete(const bsl::shared_ptr<CHT<T1, T2> > t,
                                 const T1                            k)
    {
        bsl::shared_ptr<stm::TVar<
            bsl::shared_ptr<typename List::list<bsl::pair<T1, T2> > > > >
    ...
    template <typename T1, typename T2>
    T2 stm_get_or(const bsl::shared_ptr<CHT<T1, T2> > t,
                  const T1                            k,
                  const T2                            dflt)
    {
    ...
    mk_buckets(const int num)
    {
        bsl::vector<bsl::shared_ptr<stm::TVar<
            bsl::shared_ptr<typename List::list<bsl::pair<T1, T2> > > > > >
            buckets = {};
        bsl::function<bsl::vector<bsl::shared_ptr<stm::TVar<bsl::shared_ptr<
            typename List::list<bsl::pair<T1, T2> > > > > >(unsigned int)>
            f;
        f = [&](unsigned int n)
            -> bsl::vector<bsl::shared_ptr<stm::TVar<bsl::shared_ptr<
                typename List::list<bsl::pair<T1, T2> > > > > > {
            if (n <= 0) {
                return buckets;
            }
                ...
                unsigned int n_ = n - 1;
                bsl::shared_ptr<stm::TVar<bsl::shared_ptr<
                    typename List::list<bsl::pair<T1, T2> > > > >
                    b           = stm::atomically([&] {
                        return stm::newTVar<bsl::shared_ptr<
                            typename List::list<bsl::pair<T1, T2> > > >(
                                        List::nil<bsl::pair<T1, T2> >::make());
                    });
                buckets.push_back(b);
