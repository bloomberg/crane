#ifndef INCLUDED_INDUCTIVE_PAYLOAD_FROM_SAME_SECTION
#define INCLUDED_INDUCTIVE_PAYLOAD_FROM_SAME_SECTION
...
using variant_t = std::variant<DBox,
DUnit>;
private:
  // DATA
variant_t v_;
...
#endif // INCLUDED_INDUCTIVE_PAYLOAD_FROM_SAME_SECTION
