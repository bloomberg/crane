...
(* Behavioral candidate: reset_state maps a cleared-memory state back to init_state. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module InitIsResetWithClearedMemoryProp.
...
Definition t : Prop :=
  reset_state cleared_state = init_state.

End InitIsResetWithClearedMemoryProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "init_is_reset_with_cleared_memory_prop" InitIsResetWithClearedMemoryProp.
