...
Module ListFoldRightStackOverflow.
  (** The [List] methods Crane generates for the mapped stdlib list are
      ...
      200 000-element list [List<A>::fold_right] overflows the stack (ASan reports
  ...
  Definition run (k : nat) : nat := fold_right Nat.add 0 (bld (k + 200000) []).
End ListFoldRightStackOverflow.

Crane Loopify ListFoldRightStackOverflow.bld.

Crane Extraction "list_fold_right_stack_overflow" ListFoldRightStackOverflow.
