                ...
                std::visit(
                    Overloaded{
                        ...
                        [&](const typename List<unsigned int>::Cons _args)
                          ...
                          _stack.push_back(
                              _Enter{filter_multiples(_args.d_a0, _args.d_a1),
                                     std::move(f)});
                          return {};
                        }},
                    l->v());
                ...
                std::visit(
                    Overloaded{
                        ...
                        [&](const typename List<unsigned int>::Cons _args)
                          ...
                          _stack.push_back(_Call1{_args.d_a0});
                          _stack.push_back(
                              _Enter{f, filter_out(_args.d_a0, _args.d_a1)});
                          return {};
                        }},
                    l->v());
              }
...
LoopifyAlgorithms::is_palindrome(const std::shared_ptr<List<unsigned int>> &l) {
  return list_eq_impl(l, rev_impl(List<unsigned int>::ctor::Nil_(), l));
}
                    ...
                    Overloaded{
                        ...
                        [&](const typename List<unsigned int>::Cons _args)
                          ...
                          if (len_impl(l) < n) {
                            ...
                            _stack.push_back(
                                _Call1{take_impl(n, std::move(l))});
                            _stack.push_back(_Enter{f, _args.d_a1});
                          }
                          return {};
                        }},
                    l->v());
