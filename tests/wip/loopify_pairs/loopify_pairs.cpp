        ...
        Overloaded{
            ...
            [&](_Call1 _f) {
              ...
              std::shared_ptr<LoopifyPairs::list<unsigned int>> ys =
                  _result.second;
              _result = std::make_pair(list<unsigned int>::ctor::Cons_(x, xs),
                                       list<unsigned int>::ctor::Cons_(y, ys));
            }},
        _frame);
  }
  return _result;
    ...
    std::visit(
        Overloaded{
            ...
            [&](_Call1 _f) {
              ...
              if (_args.d_a0 < pivot) {
                _result = std::make_pair(
                    list<unsigned int>::ctor::Cons_(_args.d_a0, lt),
                    std::make_pair(eq, gt));
              } else {
                if (_args.d_a0 == pivot) {
                  _result = std::make_pair(
                      lt,
                      std::make_pair(
                          list<unsigned int>::ctor::Cons_(_args.d_a0, eq), gt));
                } else {
                  _result = std::make_pair(
                      lt, std::make_pair(eq, list<unsigned int>::ctor::Cons_(
                                                 _args.d_a0, gt)));
                }
              }
            }},
...
std::shared_ptr<LoopifyPairs::list<unsigned int>> LoopifyPairs::lookup_all(
  ...
  using _Frame = std::variant<_Enter, _Call1>;
  std::shared_ptr<LoopifyPairs::list<unsigned int>> _result{};
  std::vector<_Frame> _stack;
  _stack.push_back(_Enter{l});
  while (!_stack.empty()) {
    _Frame _frame = std::move(_stack.back());
