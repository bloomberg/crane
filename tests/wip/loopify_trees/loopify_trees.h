    ...
    while (!_stack.empty()) {
      ...
      std::visit(
          Overloaded{
              [&](_Enter _f) {
                const std::shared_ptr<tree<T1>> t = _f.t;
                std::visit(Overloaded{[&](const typename tree<T1>::Leaf _args)
      ...
      std::visit(
          Overloaded{
              [&](_Enter _f) {
                ...
                std::visit(
                    Overloaded{
                        [&](const typename simple_tree::SLeaf _args) -> T1 {
                          _result = f(_args.d_a0);
                          return {};
                        },
                        [&](const typename simple_tree::SNode _args) -> T1 {
                          _stack.push_back(
