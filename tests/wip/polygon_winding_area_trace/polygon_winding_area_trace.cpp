...
__attribute__((pure)) RbaseSymbolsImpl::R Q2R(std::shared_ptr<Q> x) {
  return RbaseSymbolsImpl::Rmult(IZR(x->Qnum),
                                 RinvImpl::Rinv(IZR(Z::zpos(x->Qden))));
}

__attribute__((pure)) RbaseSymbolsImpl::R
PolygonWindingAreaTraceCase::hav(const RbaseSymbolsImpl::R theta) {
  return RIneq::Rsqr(Rtrigo_def::sin(
      ::Rdiv(theta, ::IZR(Z::zpos(Positive::xo(Positive::xh()))))));
}
...
__attribute__((pure)) RbaseSymbolsImpl::R PolygonWindingAreaTraceCase::distance(
  ...
  RbaseSymbolsImpl::R a = RbaseSymbolsImpl::Rplus(
      ...
      RbaseSymbolsImpl::Rmult(RbaseSymbolsImpl::Rmult(Rtrigo_def::cos(p1->phi),
                              ...
                              hav(dlambda)));
  return RbaseSymbolsImpl::Rmult(
      RbaseSymbolsImpl::Rmult(::IZR(Z::zpos(Positive::xo(Positive::xh()))),
                              R_earth),
...
PolygonWindingAreaTraceCase::lon_diff(const RbaseSymbolsImpl::R lon1,
  ...
  if (RIneq::Rlt_dec(Rtrigo1::PI, raw)) {
    return ::Rminus(
        raw, RbaseSymbolsImpl::Rmult(
                 ::IZR(Z::zpos(Positive::xo(Positive::xh()))), Rtrigo1::PI));
  } else {
  ...
  return std::visit(
      Overloaded{
          [](const typename List<
              ...
              -> RbaseSymbolsImpl::R { return ::IZR(Z::z0()); },
          [&](const typename List<
...
PolygonWindingAreaTraceCase::winding_number(
    ...
    const std::shared_ptr<
        List<std::shared_ptr<PolygonWindingAreaTraceCase::Point>>> &poly) {
  return ::Rdiv(winding_sum(p, poly),
...
__attribute__((pure)) bool PolygonWindingAreaTraceCase::nonnegative_area(
    const std::shared_ptr<
        List<std::shared_ptr<PolygonWindingAreaTraceCase::Point>>> &poly) {
  if (RIneq::Rle_dec(::IZR(Z::z0()), spherical_polygon_area(poly))) {
    return true;
  } else {
    return false;
  }
...
PolygonWindingAreaTraceCase::nonnegative_segment_angle(
    ...
    const std::shared_ptr<PolygonWindingAreaTraceCase::Point> &a,
    const std::shared_ptr<PolygonWindingAreaTraceCase::Point> &b) {
  if (RIneq::Rle_dec(::IZR(Z::z0()), segment_angle(p, a, b))) {
    return true;
  } else {
    return false;
  }
...
__attribute__((pure)) bool PolygonWindingAreaTraceCase::winding_number_gt_half(
    ...
    const std::shared_ptr<
        List<std::shared_ptr<PolygonWindingAreaTraceCase::Point>>> &poly) {
  if (RIneq::Rlt_dec(::Rdiv(::IZR(Z::zpos(Positive::xh())),
                            ::IZR(Z::zpos(Positive::xo(Positive::xh())))),
...
PolygonWindingAreaTraceCase::test_equatorial_square(
  ...
  return List<std::shared_ptr<PolygonWindingAreaTraceCase::Point>>::cons(
      std::make_shared<PolygonWindingAreaTraceCase::Point>(
          Point{::IZR(Z::z0()), ::IZR(Z::z0())}),
      List<std::shared_ptr<PolygonWindingAreaTraceCase::Point>>::cons(
          std::make_shared<PolygonWindingAreaTraceCase::Point>(
              Point{::IZR(Z::z0()), delta}),
          List<std::shared_ptr<PolygonWindingAreaTraceCase::Point>>::cons(
              std::make_shared<PolygonWindingAreaTraceCase::Point>(
                  Point{delta, delta}),
              List<std::shared_ptr<PolygonWindingAreaTraceCase::Point>>::cons(
                  std::make_shared<PolygonWindingAreaTraceCase::Point>(
                      Point{delta, ::IZR(Z::z0())}),
...
ConstructiveCauchyRealsMult::CRealArchimedean(const std::shared_ptr<CReal> &x) {
  std::shared_ptr<Q> q =
      x->seq(Z::zneg(Positive::xi(Positive::xh())))
          ->Qplus(std::make_shared<Q>(Q{Z::zpos(Positive::xi(Positive::xh())),
                                        Positive::xo(Positive::xh())}));
  return SigT<std::shared_ptr<Z>,
              std::pair<std::shared_ptr<Sig<std::shared_ptr<Z>>>,
                        std::shared_ptr<Sig<std::shared_ptr<Z>>>>>::
      existt(std::move(q)->Qfloor(),
              ...
              [&](const typename Sig<std::shared_ptr<Z>>::Exist _args)
                ...
                return SigT<
                    ...
                    std::pair<std::shared_ptr<Sig<std::shared_ptr<Z>>>,
                              std::shared_ptr<Sig<std::shared_ptr<Z>>>>>::
                    existt(
                        a->seq(_args.d_a0)->Qplus(b->seq(_args.d_a0))->Qmult(std::make_shared<Q>(Q{Z::zpos(Positive::xh()), Positive::xo(Positive::xh())})), std::
                                                                                                                                                                 make_pair(
                                                                                                                                                                     a->CReal_le_lt_trans(ConstructiveCauchyReals::inject_Q(a->seq(
                                                                                                                                                                                                                                 _args
                                                                                                                                                                                                                                     .d_a0)
                                                                                                                                                                                                                                ->Qplus(
                                                                                                                                                                                                                                    std::make_shared<
                                                                                                                                                                                              ...
                                                                                                                                                                                              inject_Q_lt(
                                                                                                                                                                                                  a->seq(
                                                                                                                                                                                                       _args
                                                                                                                                                                                                           .d_a0)
                                                                                                                                                                                                      ->Qplus(
                                                                                                                                                                                                          std::make_shared<Q>(Q{Z::zpos(Positive::xo(Positive::xh())), Positive::
                                                                                                                                                                                                                                                                           xh()})
                                                                                                                                                                                                              ->Qpower(
                                                                                                                                                                                                                  _args
                                                                                                                                                                                                                      .d_a0)),
                                                                                                                                                                                                  a->seq(
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      ->Qmult(
                                                                                                                                                                                                          std::
                                                                                                                                                                                                              make_shared<Q>(Q{Z::zpos(Positive::xh()), Positive::xo(
                                                                                                                                                                                                                                                            Positive::
                                                                                                                                                                                                                                                                xh())})))),
                                                                                                                                                                     b->CReal_opp()
                                                                                                                                                                         ->CReal_plus_lt_reg_l(ConstructiveCauchyReals::inject_Q(a->seq(
                                                                                                                                                                                                                                      _args
                                                                                                                                                                                                                                          .d_a0)
                                                                                                                                                                                                                                     ->Qplus(b->seq(
                                                                                                                                                                                                                                         _args
                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                     ->Qmult(
                                                                                                                                                                                                                                         std::make_shared<
                                                                                                                                                                                                                                             Q>(
                                                                                                                                                                                                                                             Q{Z::zpos(Positive::xh()), Positive::xo(Positive::
                                                                                                                                                                                                                                                                                         xh())}))),
                                                                                                                                                                                               b,
                                                                                                                                                                                               CMorphisms::
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  CMorphisms::subrelation_proper(([]()
                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                 CMorphisms::
                                                                                                                                                                                                                                                                     subrelation_respectful(
                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                         CMorphisms::
                                                                                                                                                                                                                                                                             subrelation_respectful(([]() -> std::any {
                                                                                                                                                                                                                                                                                                      throw std::
                                                                                                                                                                                                                                                                                                          logic_error(
                                                                                                                                                                                                                                                                                                              "unreachable");
                                                                                                                                                                                                                                                                                                      return std::
                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                      ->CReal_plus(
                                                                                                                                                                                                                                          ConstructiveCauchyReals::inject_Q(a->seq(
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                ->Qmult(
                                                                                                                                                                                                                                                                                    std::make_shared<
                                                                                                                                                                                                                                                                                        Q>(
                                                                                                                                                                                                                                                                                        Q{Z::zpos(Positive::xh()), Positive::xo(Positive::xh())})))))(b
                                                                                                                                                                                                                                                                                                                                                          ->CReal_opp()
                                                                                                                                                                                                                                                                                                                                                          ->CReal_plus(
                                                                                                                                                                                                                                                                                                                                                              b),
                                                                                                                                                                                                                                                                                                                                                      ConstructiveCauchyReals::inject_Q(std::
                                                                                                                                                                                                                                                                                                                                                                                            make_shared<Q>(Q{Z::z0(), Positive::xh()})),
                                                                                                                                                                                                                                                                                                                                                      ConstructiveCauchyReals::
                                                                                                                                                                                                                                                                                                                                                          inject_Q(
                                                                                                                                                                                                                                                                                                                                                              a->seq(_args
                                                                                                                                                                                                                                                                                                                                                                         .d_a0)
                                                                                                                                                                                                                                                                                                                                                                  ->Qplus(b->seq(
                                                                                                                                                                                                                                                                                                                                                                      _args
                                                                                                                                                                                                                                                                                                                                                                          .d_a0))
                                                                                                                                                                                                                                                                                                                                                                  ->Qmult(std::make_shared<Q>(Q{Z::zpos(Positive::xh()), Positive::xo(
                                                                                                                                                                                                                                                                                                                                                                                                                             Positive::
                                                                                                                                                                                                                                                                                                                                                                                                                                 xh())})))
                                                                                                                                                                                                                                                                                                                                                              ->CReal_opp()
                                                                                                                                                                                                                                                                                                                                                              ->CReal_plus_lt_reg_r(b->CReal_opp()
                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                            ->CReal_plus(ConstructiveCauchyReals::
                                                                                                                                                                                                                                                                                                                                                                                                             inject_Q(a->seq(_args
                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                          ->Qmult(std::
                                                                                                                                                                                                                                                                                                                                                                                                                                      make_shared<Q>(
                                                                                                                                                                                                                                                                                                                                                                                                                                          Q{
                                                                                                                                                                                                                                                                                                                                                                                                                                              Z::zpos(Positive::xh()), Positive::xo(Positive::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        xh())})))
                                                                                                                                                                                                                                                                                                                                                                                                                 ->CReal_plus(ConstructiveCauchyReals::
                                                                                                                                                                                                                                                                                                                                                                                                                                  inject_Q(
                                                                                                                                                                                                                                                                                                                                                                                                                                      a->seq(
                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                      inject_Q(
                                                                                                                                                                                                                                                                                                                                                                                                                                          a->seq(
                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                              ->Qplus(b->seq(_args
                                                                                                                                                                                                                                                                                                                                                                                                                                                                 .d_a0))
                                                                                                                                                                                                                                                                                                                                                                                                                                              ->Qmult(
                                                                                                                                                                                                                                                                                                                                                                                                                                                  std::make_shared<Q>(Q{Z::zpos(Positive::xh()), Positive::xo(Positive::xh())})))
                                                                                                                                                                                                                                                                                                                                                                                                                                          ->CReal_opp())))(b
                                                                                                                                                                                                                                                                                                                                                                                                                                                               ->CReal_opp()
                                                                                                                                                                                                                                                                                                                                                                                                                                                               ->CReal_plus(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ConstructiveCauchyReals::
                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                           CMorphisms::subrelation_proper(
                                                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                               [](std::shared_ptr<
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      CReal>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      x0,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                  std::shared_ptr<CReal> x1, std::shared_ptr<CReal> x2,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                  std::shared_ptr<
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      CReal>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      x3) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                 return [](const auto
                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                   CMorphisms::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                       subrelation_respectful(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                           CMorphisms::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                               iffT_flip_arrow_subrelation)),
                                                                                                                                                                                                                                                                                                                                                                                                                                                               b->CReal_opp()
                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ->CReal_plus(ConstructiveCauchyReals::inject_Q(std::make_shared<Q>(Q{Z::z0(), Positive::xh()}))))(b->CReal_opp(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ConstructiveCauchyReals::inject_Q(std::make_shared<Q>(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           Q{Z::z0(), Positive::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          xh()}))
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ConstructiveCauchyReals::inject_Q(std::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           make_shared<Q>(Q{Z::z0(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            Positive::xh()}))
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ->CReal_plus(ConstructiveCauchyReals::inject_Q(a->seq(_args
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   .d_a0)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ->Qplus(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                b
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ->seq(_args
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       CMorphisms::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           subrelation_respectful(([]()
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  CMorphisms::subrelation_respectful((
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     CMorphisms::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         iffT_flip_arrow_subrelation))),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        b->CReal_opp())(ConstructiveCauchyReals::inject_Q(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            std::make_shared<
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                Q>(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                Q{Z::z0(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  Positive::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        CMorphisms::Reflexive_partial_app_morphism(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            b->CReal_opp())(ConstructiveCauchyReals::inject_Q(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ConstructiveCauchyReals::inject_Q(a->seq(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ->Qopp()),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            b->CReal_opp()
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ->CReal_le_lt_trans(ConstructiveCauchyReals::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        inject_Q(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            b->CReal_opp()
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ->seq(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    _args
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ConstructiveCauchyReals::inject_Q_lt(b->CReal_opp()
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ->seq(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 _args
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     .d_a0)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ->Qplus(std::make_shared<Q>(Q{Z::zpos(Positive::xo(Positive::xh())), Positive::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      xh()})
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ->Qpower(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             _args
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 .d_a0)),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ->Qplus(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 b->seq(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     _args
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         .d_a0))
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ->Qmult(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 std::make_shared<Q>(Q{Z::zpos(Positive::xh()), Positive::xo(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    Positive::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        xh())}))
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ->Qopp()))))))))))));
              }},
...
Rtrigo_def::cos_n(const unsigned int n) {
  return ::Rdiv(Rpow_def::pow0(::IZR(Z::zneg(Positive::xh())), n),
...
Ratan::frame_tan(const RbaseSymbolsImpl::R y) {
  std::shared_ptr<Sumor<bool>> s =
      ::total_order_T(Rbasic_fun::Rabs(y), ::IZR(Z::zpos(Positive::xh())));
  return std::visit(
      Overloaded{
          [](const typename Sumor<bool>::Inleft _args)
              -> std::shared_ptr<Sig<RbaseSymbolsImpl::R>> {
          ...
          [&](const typename Sumor<bool>::Inright _args)
            ...
            RbaseSymbolsImpl::R u = RbaseSymbolsImpl::Rmult(
                RinvImpl::Rinv(::IZR(Z::zpos(Positive::xo(Positive::xh())))),
                RinvImpl::Rinv(RbaseSymbolsImpl::Rplus(
                    Rbasic_fun::Rabs(y), ::IZR(Z::zpos(Positive::xh())))));
            return Sig<RbaseSymbolsImpl::R>::exist(
...
Ratan::asin(const RbaseSymbolsImpl::R x) {
  if (RIneq::Rle_dec(x, ::IZR(Z::zneg(Positive::xh())))) {
    return RbaseSymbolsImpl::Ropp(
        ::Rdiv(Rtrigo1::PI, ::IZR(Z::zpos(Positive::xo(Positive::xh())))));
  } else {
    if (RIneq::Rle_dec(::IZR(Z::zpos(Positive::xh())), x)) {
      return ::Rdiv(Rtrigo1::PI, ::IZR(Z::zpos(Positive::xo(Positive::xh()))));
    } else {
      return Ratan::atan(
          ::Rdiv(x, R_sqrt::sqrt(::Rminus(::IZR(Z::zpos(Positive::xh())),
                                          RIneq::Rsqr(x)))));
    }
  }
}
