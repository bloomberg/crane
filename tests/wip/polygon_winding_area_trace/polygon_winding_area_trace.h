...
struct BinInt {
  ...
  static std::shared_ptr<Z> pow_pos(const std::shared_ptr<Z> &z,
                                    const std::shared_ptr<Positive> &_x0);
...
struct Factorial {
  __attribute__((pure)) static unsigned int fact(const unsigned int n);
};
...
struct Rbasic_fun {
  __attribute__((pure)) static RbaseSymbolsImpl::R
  Rmin(const RbaseSymbolsImpl::R x, const RbaseSymbolsImpl::R y);
  __attribute__((pure)) static RbaseSymbolsImpl::R
  Rmax(const RbaseSymbolsImpl::R x, const RbaseSymbolsImpl::R y);
  __attribute__((pure)) static bool Rcase_abs(const RbaseSymbolsImpl::R r);
  __attribute__((pure)) static RbaseSymbolsImpl::R
  Rabs(const RbaseSymbolsImpl::R r);
};
...
struct Alembert {
  template <MapsTo<RbaseSymbolsImpl::R, unsigned int> F0>
  static std::shared_ptr<Sig<RbaseSymbolsImpl::R>> Alembert_C1(F0 &&_x);
  template <MapsTo<RbaseSymbolsImpl::R, unsigned int> F0>
  static std::shared_ptr<Sig<RbaseSymbolsImpl::R>> Alembert_C2(F0 &&an);
  template <MapsTo<RbaseSymbolsImpl::R, unsigned int> F0>
  static std::shared_ptr<Sig<RbaseSymbolsImpl::R>>
  AlembertC3_step1(F0 &&an, const RbaseSymbolsImpl::R x);
  template <MapsTo<RbaseSymbolsImpl::R, unsigned int> F0>
  static std::shared_ptr<Sig<RbaseSymbolsImpl::R>>
  AlembertC3_step2(F0 &&an, const RbaseSymbolsImpl::R _x);
  template <MapsTo<RbaseSymbolsImpl::R, unsigned int> F0>
  static std::shared_ptr<Sig<RbaseSymbolsImpl::R>>
  Alembert_C3(F0 &&an, const RbaseSymbolsImpl::R x);
};
...
struct Rtrigo_def {
  __attribute__((pure)) static RbaseSymbolsImpl::R cos_n(const unsigned int n);
  static std::shared_ptr<Sig<RbaseSymbolsImpl::R>>
  exist_cos(const RbaseSymbolsImpl::R x);
  __attribute__((pure)) static RbaseSymbolsImpl::R
  cos(const RbaseSymbolsImpl::R x);
  __attribute__((pure)) static RbaseSymbolsImpl::R sin_n(const unsigned int n);
  static std::shared_ptr<Sig<RbaseSymbolsImpl::R>>
  exist_sin(const RbaseSymbolsImpl::R x);
  __attribute__((pure)) static RbaseSymbolsImpl::R
  sin(const RbaseSymbolsImpl::R x);
};
...
struct Ranalysis5 {
  template <MapsTo<RbaseSymbolsImpl::R, RbaseSymbolsImpl::R> F0>
  static std::shared_ptr<Sig<RbaseSymbolsImpl::R>>
  IVT_interv(F0 &&f, const RbaseSymbolsImpl::R x, const RbaseSymbolsImpl::R y);
};

struct Rtrigo1 {
  static inline const std::shared_ptr<Sig<RbaseSymbolsImpl::R>> PI_2_aux =
      Rsqrt_def::IVT(
...
struct Ratan {
  static std::shared_ptr<Sig<RbaseSymbolsImpl::R>>
  exists_atan_in_frame(const RbaseSymbolsImpl::R lb,
                       const RbaseSymbolsImpl::R ub,
                       const RbaseSymbolsImpl::R y);
  static std::shared_ptr<Sig<RbaseSymbolsImpl::R>>
  frame_tan(const RbaseSymbolsImpl::R y);
  static std::shared_ptr<Sig<RbaseSymbolsImpl::R>>
  pre_atan(const RbaseSymbolsImpl::R y);
  __attribute__((pure)) static RbaseSymbolsImpl::R
  atan(const RbaseSymbolsImpl::R x);
  __attribute__((pure)) static RbaseSymbolsImpl::R
  asin(const RbaseSymbolsImpl::R x);
  __attribute__((pure)) static RbaseSymbolsImpl::R
  acos(const RbaseSymbolsImpl::R x);
};
...
struct PolygonWindingAreaTraceCase {
  struct Point {
    RbaseSymbolsImpl::R phi;
    RbaseSymbolsImpl::R lambda;
  };
  ...
  __attribute__((pure)) static RbaseSymbolsImpl::R
  distance(const std::shared_ptr<Point> &p1, const std::shared_ptr<Point> &p2);
  ...
  __attribute__((pure)) static RbaseSymbolsImpl::R
  lon_diff(const RbaseSymbolsImpl::R lon1, const RbaseSymbolsImpl::R lon2);
  __attribute__((pure)) static RbaseSymbolsImpl::R spherical_shoelace_aux(
  ...
  __attribute__((pure)) static RbaseSymbolsImpl::R spherical_polygon_area(
      const std::shared_ptr<List<std::shared_ptr<Point>>> &poly);
  __attribute__((pure)) static RbaseSymbolsImpl::R
  distance_to_central_angle(const RbaseSymbolsImpl::R d);
  __attribute__((pure)) static RbaseSymbolsImpl::R
  spherical_cosine_arg(const RbaseSymbolsImpl::R ca,
                       const RbaseSymbolsImpl::R cb,
                       const RbaseSymbolsImpl::R cab);
  __attribute__((pure)) static RbaseSymbolsImpl::R
  law_of_cosines_arg(const RbaseSymbolsImpl::R da, const RbaseSymbolsImpl::R db,
...
_x0);
     ...
     template <MapsTo<RbaseSymbolsImpl::R, unsigned int> F0>
     std::shared_ptr<Sig<RbaseSymbolsImpl::R>> Alembert::Alembert_C1(F0 &&_x) {
       std::shared_ptr<Sig<std::any>> h2 = Raxioms::completeness();
       return std::visit(
           Overloaded{[](const typename Sig<std::any>::Exist _args)
     ...
     template <MapsTo<RbaseSymbolsImpl::R, unsigned int> F0>
     std::shared_ptr<Sig<RbaseSymbolsImpl::R>> Alembert::Alembert_C2(F0 &&an) {
       std::function<RbaseSymbolsImpl::R(unsigned int)> vn =
       ...
       return std::visit(
           Overloaded{[&](const typename Sig<RbaseSymbolsImpl::R>::Exist _args)
                          -> std::shared_ptr<Sig<RbaseSymbolsImpl::R>> {
             std::shared_ptr<Sig<RbaseSymbolsImpl::R>> h6 =
                 Alembert::Alembert_C1(wn);
             return [&](void) {
               if (std::move(h6).use_count() == 1 &&
                   std::move(h6)->v().index() == 0) {
                 auto &_rf = std::get<0>(std::move(h6)->v_mut());
                 RbaseSymbolsImpl::R x0 = std::move(_rf.d_a0);
                 _rf.d_a0 = ::Rminus(_args.d_a0, std::move(x0));
                 return std::move(h6);
               } else {
                 return std::visit(
                     Overloaded{
     ...
     template <MapsTo<RbaseSymbolsImpl::R, unsigned int> F0>
     std::shared_ptr<Sig<RbaseSymbolsImpl::R>>
     Alembert::AlembertC3_step1(F0 &&an, const RbaseSymbolsImpl::R x) {
       std::function<RbaseSymbolsImpl::R(unsigned int)> bn =
           [=](unsigned int i) mutable {
             return RbaseSymbolsImpl::Rmult(an(i), Rpow_def::pow0(x, i));
           };
       std::shared_ptr<Sig<RbaseSymbolsImpl::R>> s = Alembert::Alembert_C2(bn);
       return [&](void) {
         if (std::move(s).use_count() == 1 && std::move(s)->v().index() == 0) {
           auto &_rf = std::get<0>(std::move(s)->v_mut());
           RbaseSymbolsImpl::R x0 = std::move(_rf.d_a0);
     ...
     Alembert::Alembert_C3(F0 &&an, const RbaseSymbolsImpl::R x) {
       ...
       return std::visit(
           Overloaded{[&](const typename Sumor<bool>::Inleft _args)
                          -> std::shared_ptr<Sig<RbaseSymbolsImpl::R>> {
                        if (_args.d_a0) {
                          return Alembert::AlembertC3_step1(an, x);
                        } else {
                          return Alembert::AlembertC3_step2(an, x);
                        }
                      },
     ...
     template <MapsTo<RbaseSymbolsImpl::R, RbaseSymbolsImpl::R> F0>
     std::shared_ptr<Sig<RbaseSymbolsImpl::R>>
     Ranalysis5::IVT_interv(F0 &&f, const RbaseSymbolsImpl::R x,
                            const RbaseSymbolsImpl::R y) {
       std::shared_ptr<Sig<RbaseSymbolsImpl::R>> x0 =
           Rsqrt_def::dicho_up_cv(x, y, [=](RbaseSymbolsImpl::R z) mutable {
             return Rsqrt_def::cond_positivity(f(z));
           });
       std::shared_ptr<Sig<RbaseSymbolsImpl::R>> x1 =
           Rsqrt_def::dicho_lb_cv(x, y, [=](RbaseSymbolsImpl::R z) mutable {
             return Rsqrt_def::cond_positivity(f(z));
           });
       return std::visit(
           Overloaded{[&](const typename Sig<RbaseSymbolsImpl::R>::Exist _args)
                          -> auto {
             return [&](void) {
               if (std::move(x1).use_count() == 1 &&
                   std::move(x1)->v().index() == 0) {
                 auto &_rf = std::get<0>(std::move(x1)->v_mut());
                 _rf.d_a0 = std::move(_args.d_a0);
                 return std::move(x1);
               } else {
                 return std::visit(
                     Overloaded{
