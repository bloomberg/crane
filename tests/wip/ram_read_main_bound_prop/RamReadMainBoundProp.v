...
(* Behavioral candidate: ram_read_main returns a nibble-bounded value on init_state. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module RamReadMainBoundProp.
...
Definition t : Prop :=
  ram_read_main init_state < 16.

End RamReadMainBoundProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "ram_read_main_bound_prop" RamReadMainBoundProp.
