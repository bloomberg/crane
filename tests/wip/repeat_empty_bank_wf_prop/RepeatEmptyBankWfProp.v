...
(* Behavioral candidate: repeating empty_bank preserves WF_bank over the list. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module RepeatEmptyBankWfProp.
...
Definition t : Prop :=
  Forall WF_bank (repeat empty_bank 4).

End RepeatEmptyBankWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "repeat_empty_bank_wf_prop" RepeatEmptyBankWfProp.
