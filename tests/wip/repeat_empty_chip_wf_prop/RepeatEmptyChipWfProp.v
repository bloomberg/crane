...
(* Behavioral candidate: repeating empty_chip preserves WF_chip over the list. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module RepeatEmptyChipWfProp.
...
Definition t : Prop :=
  Forall WF_chip (repeat empty_chip 4).

End RepeatEmptyChipWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "repeat_empty_chip_wf_prop" RepeatEmptyChipWfProp.
