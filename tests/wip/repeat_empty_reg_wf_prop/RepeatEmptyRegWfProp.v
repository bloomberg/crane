...
(* Behavioral candidate: repeating empty_reg preserves WF_reg over the list. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module RepeatEmptyRegWfProp.
...
Definition t : Prop :=
  Forall WF_reg (repeat empty_reg 4).

End RepeatEmptyRegWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "repeat_empty_reg_wf_prop" RepeatEmptyRegWfProp.
