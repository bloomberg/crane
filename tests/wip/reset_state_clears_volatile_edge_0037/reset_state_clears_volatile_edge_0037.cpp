...
#include <memory>
#include <optional>
#include <reset_state_clears_volatile_edge_0037.h>
#include <stdexcept>
#include <string>
#include <utility>
#include <variant>

std::shared_ptr<ResetStateClearsVolatileEdge0037::instruction>
ResetStateClearsVolatileEdge0037::decode(const unsigned int b1,
...
std::shared_ptr<
    List<std::shared_ptr<ResetStateClearsVolatileEdge0037::instruction>>>
ResetStateClearsVolatileEdge0037::decode_list(
    const std::shared_ptr<List<unsigned int>> &bytes) {
  return std::visit(
      Overloaded{
          [](const typename List<unsigned int>::nil _args)
              -> std::shared_ptr<List<std::shared_ptr<
                  ResetStateClearsVolatileEdge0037::instruction>>> {
            return List<std::shared_ptr<
                ResetStateClearsVolatileEdge0037::instruction>>::ctor::nil_();
          },
              ...
              if (std::move(l).use_count() == 1 &&
                ...
                return std::visit(
                    Overloaded{
                        [](const typename List<unsigned int>::nil _args)
                            -> std::shared_ptr<List<std::shared_ptr<
                                ResetStateClearsVolatileEdge0037::
                                    instruction>>> {
                          return List<std::shared_ptr<
                              ResetStateClearsVolatileEdge0037::instruction>>::
                              ctor::nil_();
