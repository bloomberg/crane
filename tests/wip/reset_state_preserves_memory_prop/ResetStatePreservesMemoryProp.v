...
(* Behavioral candidate: reset_state preserves register, RAM, and ROM memory contents. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ResetStatePreservesMemoryProp.
...
Definition t : Prop :=
  state_regs (reset_state init_state) = state_regs init_state /\
  state_ram (reset_state init_state) = state_ram init_state /\
  state_rom (reset_state init_state) = state_rom init_state.

End ResetStatePreservesMemoryProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "reset_state_preserves_memory_prop" ResetStatePreservesMemoryProp.
