...
(* Behavioral candidate: reset_state preserves WF on a canonical initial state. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ResetStateWfProp.
...
Definition t : Prop :=
  WF init_state /\
  WF (reset_state init_state).

End ResetStateWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "reset_state_wf_prop" ResetStateWfProp.
