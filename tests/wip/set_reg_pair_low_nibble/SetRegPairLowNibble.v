...
(* Behavioral candidate: set_reg_pair stores the low nibble in the successor register. *)

From Stdlib Require Import List Nat.
Import ListNotations.

Module SetRegPairLowNibble.
...
Definition t : nat := get_reg (set_reg_pair (mkState [0; 0; 0; 0]) 2 171) 3.

End SetRegPairLowNibble.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "set_reg_pair_low_nibble" SetRegPairLowNibble.
