#ifndef INCLUDED_SHARED_DEP_TWO_TARGETS_B
#define INCLUDED_SHARED_DEP_TWO_TARGETS_B
...
struct SharedDepTwoTargetsB {
  static inline const bool test2 = []() {
    switch (flip(Col::GREEN)) {
    case Col::RED: {
      return true;
    }
    case Col::GREEN: {
...
#endif // INCLUDED_SHARED_DEP_TWO_TARGETS_B
