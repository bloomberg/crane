...
#include <stdexcept>
#include <string>
#include <update_nth_length_edge_0009.h>
#include <utility>
#include <variant>

std::shared_ptr<UpdateNthLengthEdge0009::instruction>
UpdateNthLengthEdge0009::decode(const unsigned int b1, const unsigned int b2) {
  if ((b1 == 0u)) {
...
std::shared_ptr<List<std::shared_ptr<UpdateNthLengthEdge0009::instruction>>>
UpdateNthLengthEdge0009::decode_list(
    const std::shared_ptr<List<unsigned int>> &bytes) {
  return std::visit(
      Overloaded{
          [](const typename List<unsigned int>::nil _args)
              -> std::shared_ptr<
                  List<std::shared_ptr<UpdateNthLengthEdge0009::instruction>>> {
            return List<std::shared_ptr<UpdateNthLengthEdge0009::instruction>>::
                ctor::nil_();
          },
                    ...
                    Overloaded{
                        [](const typename List<unsigned int>::nil _args)
                            -> std::shared_ptr<List<std::shared_ptr<
                                UpdateNthLengthEdge0009::instruction>>> {
                          return List<std::shared_ptr<
                              UpdateNthLengthEdge0009::instruction>>::ctor::
                              nil_();
                        },
                        [&](const typename List<unsigned int>::cons _args)
                            -> std::shared_ptr<List<std::shared_ptr<
