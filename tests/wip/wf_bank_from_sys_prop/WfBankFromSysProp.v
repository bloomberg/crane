...
(* Behavioral candidate: a selected bank from a WF system is WF_bank. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module WfBankFromSysProp.
...
Definition t : Prop :=
  WF init_state /\
  WF_bank (get_bank_from_sys (state_ram init_state) 0).

End WfBankFromSysProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "wf_bank_from_sys_prop" WfBankFromSysProp.
