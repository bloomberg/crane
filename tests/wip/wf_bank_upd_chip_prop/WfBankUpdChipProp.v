...
(* Behavioral candidate: updating a chip inside a bank preserves WF_bank. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module WfBankUpdChipProp.
...
Definition t : Prop :=
  WF_bank empty_bank /\
  WF_chip empty_chip /\
  WF_bank (upd_chip_in_bank empty_bank 1 empty_chip).

End WfBankUpdChipProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "wf_bank_upd_chip_prop" WfBankUpdChipProp.
