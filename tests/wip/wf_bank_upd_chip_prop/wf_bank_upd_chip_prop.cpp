...
#include <utility>
#include <variant>
#include <wf_bank_upd_chip_prop.h>
...
std::shared_ptr<WfBankUpdChipProp::ram_reg> WfBankUpdChipProp::get_regRAM(
    const std::shared_ptr<WfBankUpdChipProp::ram_chip> &ch,
    const unsigned int r) {
  return ch->chip_regs->nth(r, empty_reg);
}

std::shared_ptr<WfBankUpdChipProp::ram_chip> WfBankUpdChipProp::upd_reg_in_chip(
    std::shared_ptr<WfBankUpdChipProp::ram_chip> ch, const unsigned int r,
    std::shared_ptr<WfBankUpdChipProp::ram_reg> rg) {
  return std::make_shared<WfBankUpdChipProp::ram_chip>(
      ram_chip{update_nth<std::shared_ptr<WfBankUpdChipProp::ram_reg>>(
...
std::shared_ptr<WfBankUpdChipProp::ram_chip> WfBankUpdChipProp::get_chip(
    const std::shared_ptr<WfBankUpdChipProp::ram_bank> &bk,
    const unsigned int c) {
  return bk->bank_chips->nth(c, empty_chip);
}

std::shared_ptr<WfBankUpdChipProp::ram_bank>
WfBankUpdChipProp::upd_chip_in_bank(
    std::shared_ptr<WfBankUpdChipProp::ram_bank> bk, const unsigned int c,
    std::shared_ptr<WfBankUpdChipProp::ram_chip> ch) {
  return std::make_shared<WfBankUpdChipProp::ram_bank>(
      ram_bank{update_nth<std::shared_ptr<WfBankUpdChipProp::ram_chip>>(
          std::move(c), std::move(ch), std::move(bk)->bank_chips)});
}

std::shared_ptr<WfBankUpdChipProp::ram_bank>
WfBankUpdChipProp::get_bank_from_sys(
    const std::shared_ptr<List<std::shared_ptr<WfBankUpdChipProp::ram_bank>>>
        &sys,
    const unsigned int b) {
  return sys->nth(b, empty_bank);
}

std::shared_ptr<List<std::shared_ptr<WfBankUpdChipProp::ram_bank>>>
WfBankUpdChipProp::upd_bank_in_sys(
    const std::shared_ptr<WfBankUpdChipProp::state> &s, const unsigned int b,
    const std::shared_ptr<WfBankUpdChipProp::ram_bank> &bk) {
  return update_nth<std::shared_ptr<WfBankUpdChipProp::ram_bank>>(b, bk,
                                                                  s->state_ram);
}

std::shared_ptr<WfBankUpdChipProp::ram_bank> WfBankUpdChipProp::current_bank(
    const std::shared_ptr<WfBankUpdChipProp::state> &s) {
  return get_bank_from_sys(s->state_ram, s->state_sel->sel_bank);
}

std::shared_ptr<WfBankUpdChipProp::ram_chip> WfBankUpdChipProp::current_chip(
    const std::shared_ptr<WfBankUpdChipProp::state> &s) {
  return get_chip(current_bank(s), s->state_sel->sel_chip);
}

std::shared_ptr<WfBankUpdChipProp::ram_reg> WfBankUpdChipProp::current_reg(
    const std::shared_ptr<WfBankUpdChipProp::state> &s) {
  return get_regRAM(current_chip(s), s->state_sel->sel_reg);
}

unsigned int WfBankUpdChipProp::ram_read_main(
    const std::shared_ptr<WfBankUpdChipProp::state> &s) {
  return get_main(current_reg(s), s->state_sel->sel_char);
}

std::shared_ptr<List<std::shared_ptr<WfBankUpdChipProp::ram_bank>>>
WfBankUpdChipProp::ram_write_main_sys(
    const std::shared_ptr<WfBankUpdChipProp::state> &s, const unsigned int v) {
  std::shared_ptr<WfBankUpdChipProp::ram_reg> rg = current_reg(s);
  std::shared_ptr<WfBankUpdChipProp::ram_chip> ch = current_chip(s);
  std::shared_ptr<WfBankUpdChipProp::ram_bank> bk = current_bank(s);
  std::shared_ptr<WfBankUpdChipProp::ram_reg> rg_ =
      upd_main_in_reg(std::move(rg), s->state_sel->sel_char, v);
  std::shared_ptr<WfBankUpdChipProp::ram_chip> ch_ =
      upd_reg_in_chip(std::move(ch), s->state_sel->sel_reg, std::move(rg_));
  std::shared_ptr<WfBankUpdChipProp::ram_bank> bk_ =
      upd_chip_in_bank(std::move(bk), s->state_sel->sel_chip, std::move(ch_));
  return upd_bank_in_sys(s, s->state_sel->sel_bank, std::move(bk_));
}

std::shared_ptr<List<std::shared_ptr<WfBankUpdChipProp::ram_bank>>>
WfBankUpdChipProp::ram_write_status_sys(
    const std::shared_ptr<WfBankUpdChipProp::state> &s, const unsigned int idx,
    const unsigned int v) {
  std::shared_ptr<WfBankUpdChipProp::ram_reg> rg = current_reg(s);
  std::shared_ptr<WfBankUpdChipProp::ram_chip> ch = current_chip(s);
  std::shared_ptr<WfBankUpdChipProp::ram_bank> bk = current_bank(s);
...
std::pair<std::optional<unsigned int>,
          std::shared_ptr<WfBankUpdChipProp::state>>
WfBankUpdChipProp::pop_stack(std::shared_ptr<WfBankUpdChipProp::state> s) {
  return std::visit(
      Overloaded{[&](const typename List<unsigned int>::nil _args)
                 ...
                 [&](const typename List<unsigned int>::cons _args)
                   ...
                   return std::make_pair(
                       ...
                       std::make_shared<WfBankUpdChipProp::state>(
