...
(* Behavioral candidate: a selected chip from a WF bank is WF_chip. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module WfChipFromBankProp.
...
Definition t : Prop :=
  WF_bank empty_bank /\
  WF_chip (get_chip empty_bank 0).

End WfChipFromBankProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "wf_chip_from_bank_prop" WfChipFromBankProp.
