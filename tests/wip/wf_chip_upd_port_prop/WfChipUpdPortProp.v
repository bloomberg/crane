...
(* Behavioral candidate: updating a chip port preserves WF_chip. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module WfChipUpdPortProp.
...
Definition t : Prop :=
  WF_chip empty_chip /\
  WF_chip (upd_port_in_chip empty_chip 12).

End WfChipUpdPortProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "wf_chip_upd_port_prop" WfChipUpdPortProp.
