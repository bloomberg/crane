...
(* Behavioral candidate: updating a register inside a chip preserves WF_chip. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module WfChipUpdRegProp.
...
Definition t : Prop :=
  WF_chip empty_chip /\
  WF_reg empty_reg /\
  WF_chip (upd_reg_in_chip empty_chip 2 empty_reg).

End WfChipUpdRegProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "wf_chip_upd_reg_prop" WfChipUpdRegProp.
