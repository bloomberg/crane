...
(* Behavioral candidate: a selected register from a WF chip is WF_reg. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module WfRegFromChipProp.
...
Definition t : Prop :=
  WF_chip empty_chip /\
  WF_reg (get_regRAM empty_chip 0).

End WfRegFromChipProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "wf_reg_from_chip_prop" WfRegFromChipProp.
