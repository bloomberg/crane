...
(* Behavioral candidate: updating a main character preserves WF_reg. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module WfRegUpdMainProp.
...
Definition t : Prop :=
  WF_reg empty_reg /\
  WF_reg (upd_main_in_reg empty_reg 3 7).

End WfRegUpdMainProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "wf_reg_upd_main_prop" WfRegUpdMainProp.
