...
(* Behavioral candidate: updating a status character preserves WF_reg. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module WfRegUpdStatProp.
...
Definition t : Prop :=
  WF_reg empty_reg /\
  WF_reg (upd_stat_in_reg empty_reg 1 5).

End WfRegUpdStatProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "wf_reg_upd_stat_prop" WfRegUpdStatProp.
