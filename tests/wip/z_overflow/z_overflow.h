...
struct ZOverflow {
  ...
  static inline const int64_t big_z = static_cast<int64_t>((
      2u *
          (2u *
               (2u *
                    (2u *
      ...
      1u));
  /// negative 10 billion
  static inline const int64_t big_neg_z = (-static_cast<int64_t>((
      2u *
          (2u *
               (2u *
                    (2u *
  ...
  static inline const int64_t z_pow2_33 = static_cast<int64_t>((
      2u *
      (2u *
       (2u *
        (2u *
  ...
  static inline const int64_t z_fits = static_cast<int64_t>((
      2u *
      (2u *
       (2u *
        (2u *
