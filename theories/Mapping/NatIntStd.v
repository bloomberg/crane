...
Crane Extract Inlined Constant PeanoNat.Nat.max => "std::max(%a0, %a1)" From "algorithm".
Crane Extract Inlined Constant PeanoNat.Nat.min => "std::min(%a0, %a1)" From "algorithm".
